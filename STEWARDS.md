...
*Standing writing voice is **Riyo**; **Quin** still stewards the Q-vane faculties (`oven/` · `lantern/` · `lattice/` · `scribble/`) below.*
...
| `oven/` · `lantern/` · `lattice/` · `scribble/` | Faculties | **Quin** |
