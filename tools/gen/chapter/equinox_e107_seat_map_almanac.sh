...
entry = (
    ...
    "**Ran:** `rishi/bin/rishi run tools/gen/chapter/equinox_e107_seat_map_choir_witness.rish` · **Stamp:** `"
    + stamp
    + "` · **Witness:** `tools/gen/chapter/equinox_e107_seat_map_witness.rish` · scan `tools/fixtures/equinox_seat_map_scan.sh` · pin `work-in-progress/EQUINOX_SEAT_MAP.md`\n"
