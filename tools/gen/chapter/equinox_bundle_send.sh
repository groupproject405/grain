...
#
#   sh tools/gen/chapter/equinox_bundle_send.sh rehearsal
#   sh tools/gen/chapter/equinox_bundle_send.sh rehearsal --span HEAD~20..HEAD
#   sh tools/gen/chapter/equinox_bundle_send.sh closing e255
#   sh tools/gen/chapter/equinox_bundle_send.sh wave q64
#   sh tools/gen/chapter/equinox_bundle_send.sh prove-red
#
