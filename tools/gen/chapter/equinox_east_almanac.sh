...
entry = (
    ...
    "**Ran:** `rishi/bin/rishi run tools/gen/chapter/equinox_east_almanac_witness.rish` · **Stamp:** `"
    + stamp
    + "` · **Witness:** `tools/gen/chapter/equinox_east_almanac_witness.rish` · `tools/gen/chapter/equinox_e1_east_pack_witness.rish`\n"
