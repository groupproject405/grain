...
entry = (
    ...
    "**Ran:** `rishi/bin/rishi run tools/gen/chapter/equinox_e102_fascia_chase_choir_witness.rish` · **Stamp:** `"
    + stamp
    + "` · **Witness:** `tools/gen/chapter/equinox_e102_fascia_chase_witness.rish` · scan `tools/fixtures/equinox_e102_fascia_chase_scan.sh` · choir `equinox_e102_fascia_chase_choir_witness.rish`\n"
