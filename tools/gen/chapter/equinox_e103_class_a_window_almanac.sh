...
entry = (
    ...
    "**Ran:** `rishi/bin/rishi run tools/gen/chapter/equinox_e103_class_a_window_choir_witness.rish` · **Stamp:** `"
    + stamp
    + "` · **Witness:** `tools/gen/chapter/equinox_e103_class_a_window_witness.rish` · scan `tools/fixtures/equinox_e103_class_a_window_scan.sh` · choir `equinox_e103_class_a_window_choir_witness.rish`\n"
