...
entry = (
    ...
    "**Ran:** `rishi/bin/rishi run tools/gen/chapter/equinox_tigerbeetle_surfaces_hold_witness.rish` · **Stamp:** `"
    + stamp
    + "` · **Witness:** `tools/gen/chapter/equinox_tigerbeetle_surfaces_hold_witness.rish` · iron `tools/fixtures/ironbeetle_shelf_census.sh`\n"
