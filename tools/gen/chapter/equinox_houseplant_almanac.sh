...
entry = (
    ...
    "**Ran:** `rishi/bin/rishi run tools/gen/chapter/houseplant_glossary_witness.rish` · **Stamp:** `"
    + stamp
    + "` · **Witness:** `tools/gen/chapter/houseplant_glossary_witness.rish` · `context/LEXICON.md`\n"
