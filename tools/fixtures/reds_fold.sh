#!/bin/sh
# tools/fixtures/reds_fold.sh -- move closed REDS rows onto a shelf, links re-anchored.
#
...
# the loom.
#
#   sh tools/fixtures/reds_fold.sh construction/archive/REDS-<sprig>-rows-<a>-<b>.md 266 267 268
#
...
#
# Proven by tools/fixtures/reds_fold_control.sh over real files in a throwaway pen, refusals and
...
REANCHOR=tools/fixtures/reds_fold_reanchor.sh
