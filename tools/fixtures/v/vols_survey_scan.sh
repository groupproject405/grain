#!/bin/sh
# tools/fixtures/v/vols_survey_scan.sh -- CION VOLS Journey 13, the derived survey census.
#
#   sh tools/fixtures/v/vols_survey_scan.sh <root>
#
# Where the module labeling guard (tools/fixtures/l/labeling_module_scan.sh) scans a
