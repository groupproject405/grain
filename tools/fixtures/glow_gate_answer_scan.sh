#!/bin/sh
# tools/fixtures/glow_gate_answer_scan.sh -- a witness that runs a lowered binary must read what the
...
#
# USAGE
#   sh tools/fixtures/glow_gate_answer_scan.sh                # the real tracked .rish surface
