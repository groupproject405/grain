...
#
#   sh tools/fixtures/f/fascia_health_scan.sh           # living green
#   sh tools/fixtures/f/fascia_health_scan.sh prove-red  # must exit 1
#
...
REPORT=$(rishi/bin/rishi run tools/fixtures/d/dated_classify.rish health "$LIVE" "$DATED")
