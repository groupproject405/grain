#!/bin/sh
# tools/fixtures/f/fetch_toolchain_scan.sh -- fetch and verify the pinned Zig toolchain.
#
...
#
# USAGE
#   sh tools/fixtures/f/fetch_toolchain_scan.sh              # fetch if absent, verify, extract
#   sh tools/fixtures/f/fetch_toolchain_scan.sh plan         # say what it would do; touch nothing
#   sh tools/fixtures/f/fetch_toolchain_scan.sh verify F H    # verify one file against one hash
#
