#!/bin/sh
# tools/fixtures/f/fascia_home_link_scan.sh -- how many room READMEs offer no path back home.
#
...
#
# USAGE
#   sh tools/fixtures/f/fascia_home_link_scan.sh          # count
#   sh tools/fixtures/f/fascia_home_link_scan.sh --list   # name every page with no path home
#
