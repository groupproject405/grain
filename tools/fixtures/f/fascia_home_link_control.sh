#!/bin/sh
# tools/fixtures/f/fascia_home_link_control.sh -- the fascia meter, proven on planted pages.
#
...
#
# USAGE
#   sh tools/fixtures/f/fascia_home_link_control.sh
#
# Run from the repository root; it reads only the scan script from there.

set -u

scan=$PWD/tools/fixtures/f/fascia_home_link_scan.sh
