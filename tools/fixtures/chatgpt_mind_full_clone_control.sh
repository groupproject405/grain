...
MIND_LANE="$ROOT/tools/fixtures/chatgpt_mind_lane.awk"
...
require_launcher 'assert candidate_lane_run.ok else "REFUSE chatgpt-mind: staged candidate escapes the authored regular Brushstroke and Surf lane"' 'pre-hook lane enforcement'
require_launcher 'assert hook_lane_run.ok else "REFUSE chatgpt-mind: jailed hooks escaped the authored regular Brushstroke and Surf lane"' 'post-hook lane enforcement'
