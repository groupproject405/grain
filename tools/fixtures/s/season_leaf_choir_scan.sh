#!/bin/sh
# tools/fixtures/s/season_leaf_choir_scan.sh -- sing the season room's LEAF witnesses.
#
...
#
#   sh tools/fixtures/s/season_leaf_choir_scan.sh              # sing the room
#   sh tools/fixtures/s/season_leaf_choir_scan.sh prove-red    # plant one refusal, prove it is caught
#   sh tools/fixtures/s/season_leaf_choir_scan.sh --list       # print what it WOULD sing, run nothing
#
...
# ls-files call costs two readers at once: tools/fixtures/w/witness_reach_scan.sh cannot tell what
...
# tools/fixtures/w/witness_reach_scan.sh, which otherwise has to guess a discovering choir's reach
