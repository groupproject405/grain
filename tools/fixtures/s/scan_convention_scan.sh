#!/bin/sh
# tools/fixtures/s/scan_convention_scan.sh -- the convention stays single-homed.
#
...
self="tools/fixtures/s/scan_convention_scan.sh"

# Blocking roster: scans authored under this convention.
roster="tools/fixtures/b/bounds_typed_scan.sh
tools/fixtures/c/copy_sameness_scan.sh
tools/fixtures/c/counsel_flow_scan.sh
tools/fixtures/d/dep_crawl_scan.sh
tools/fixtures/v/voice_roster_scan.sh"
