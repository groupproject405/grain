# tools/fixtures/s/skate_circle_truth.awk — an independent measurement of a Skate circle fixture.
#
...
#
#   awk -f tools/fixtures/s/skate_circle_truth.awk surf/fixtures/circle.bron
