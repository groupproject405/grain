...
reds_fold DISCOVERY
reds_ledger_headline tools/r/reds_ledger_headline_witness.rish construction/REDS.md construction/archive/REDS/REDS-* tools/fixtures/r/reds_ledger_headline_control.sh
reds_ledger_monotone tools/gen/chapter/reds_ledger_monotone_witness.rish tools/fixtures/r/reds_ledger_monotone_scan.sh construction/REDS.md construction/archive/REDS/REDS-* tools/fixtures/p/plant.sh
