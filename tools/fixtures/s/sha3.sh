#!/bin/sh
# tools/fixtures/s/sha3.sh -- SHA3-256 or SHA3-512, from this tree's own Keccak.
#
...
#
# USAGE
#   sh tools/fixtures/s/sha3.sh 256 <path>     # 64 lowercase hex characters
#   sh tools/fixtures/s/sha3.sh 512 <path>     # 128 lowercase hex characters
#   sh tools/fixtures/s/sha3.sh 512 -          # hash standard input
#
