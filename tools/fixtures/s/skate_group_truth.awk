# tools/fixtures/s/skate_group_truth.awk — an independent measurement of a Skate group fixture.
#
...
#
#   awk -f tools/fixtures/s/skate_group_truth.awk surf/fixtures/group.bron
