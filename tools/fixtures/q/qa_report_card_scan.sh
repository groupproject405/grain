#!/bin/sh
# tools/fixtures/q/qa_report_card_scan.sh -- the front doors, read as report cards.
#
# WHY. tools/fixtures/p/prose_register_scan.sh gates one of the four readings a report card carries,
...
#
# USAGE
#   sh tools/fixtures/q/qa_report_card_scan.sh
#
...
reg="$root/tools/fixtures/p/prose_register_scan.sh"
