...
#
#   sh tools/fixtures/pond_enclosure_policy_scan.sh
set -eu
...
REFUSE="$ROOT/tools/fixtures/pond_enclosure_policy_refuse.kyri"
HOLD="$ROOT/tools/fixtures/pond_enclosure_policy_hold.kyri"
