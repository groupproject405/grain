#!/bin/sh
# tools/fixtures/a/ales_sing_lock.sh -- one sing of the Lotus choir at a time.
#
...
#
# The shape is `tools/fixtures/s/sow_project.sh`'s, and the reasoning there holds here word for word:
...
#
# USAGE
#   sh tools/fixtures/a/ales_sing_lock.sh take   # 0 taken, 3 already held
#   sh tools/fixtures/a/ales_sing_lock.sh free   # always 0; freeing an unheld lock is a no-op
#
