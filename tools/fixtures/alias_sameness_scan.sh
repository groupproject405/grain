#!/bin/sh
# tools/fixtures/alias_sameness_scan.sh -- several lawful names keep one identity.
set -eu
...
LIVING_FILES=${ALIAS_SAMENESS_LIVING_FILES:-"context/LEXICON.md tools/l/launch-mind-cardinal-chapter.rish active-designing/20260826-151528_the-three-stars-of-the-aether-row.md skate/README.md"}
