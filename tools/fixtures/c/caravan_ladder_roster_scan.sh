#!/bin/sh
# tools/fixtures/c/caravan_ladder_roster_scan.sh -- the ladder table names every module beside it.
#
...
#
# USAGE
#   sh tools/fixtures/c/caravan_ladder_roster_scan.sh              # census -- key=value lines
#   sh tools/fixtures/c/caravan_ladder_roster_scan.sh list         # every fault, one per line
#   sh tools/fixtures/c/caravan_ladder_roster_scan.sh census DIR   # read DIR rather than caravan/
#
