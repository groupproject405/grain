...
#
# Usage: sh tools/fixtures/c/caravan_address_space_scan_control.sh <memory_region.rs> <table-output-file>
...
source_file="$1"
table="$2"
scan="tools/fixtures/c/caravan_address_space_symbol_scan.sh"
