...
#
# Usage: sh tools/fixtures/c/caravan_allowance_widen_control.sh <zig> <pen-dir>
...
# the first ancestor holding rishi/src and tools/fixtures -- git-free so pen copies
