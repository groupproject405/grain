#!/bin/sh
# tools/fixtures/c/comment_dial_scan.sh -- read the dial that runs through the code.
#
...
#
# USAGE
#   sh tools/fixtures/c/comment_dial_scan.sh            # the tree reading
#   sh tools/fixtures/c/comment_dial_scan.sh modules    # one row per module
#
