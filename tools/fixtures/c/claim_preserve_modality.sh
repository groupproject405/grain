...
#
# Usage:
#   sh tools/fixtures/c/claim_preserve_modality.sh count <file>
#   sh tools/fixtures/c/claim_preserve_modality.sh compare <before-file> <after-file>
#   sh tools/fixtures/c/claim_preserve_modality.sh selftest
#
...
if cmd == "count":
    ...
    import subprocess
    r = subprocess.run(
        ["sh", "tools/fixtures/c/claim_preserve_modality.sh", "compare", str(before), str(after2)],
