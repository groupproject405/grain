#!/bin/sh
# tools/fixtures/c/crypto_tool_declaration_control.sh -- prove the tool declaration bites, on real trees.
#
# WHY. tools/fixtures/c/crypto_tool_declaration_scan.sh excuses a crypto/*.rye from the suite bijection.
...
#
# USAGE
#   sh tools/fixtures/c/crypto_tool_declaration_control.sh
#
# Run from the repository root.
set -eu

SCAN="$(pwd)/tools/fixtures/c/crypto_tool_declaration_scan.sh"
PEN=$(mktemp -d)
