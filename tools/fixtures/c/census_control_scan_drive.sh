...
#
#   sh tools/fixtures/c/census_control_scan_drive.sh
#   sh tools/fixtures/c/census_control_scan_drive.sh prove-red
set -eu

MODE=${1:-}
H1=tools/fixtures/c/census_control_h1_seam.sh
MARKER=tools/fixtures/c/census_control_marker_seam.sh
TRACKED=tools/fixtures/c/census_control_tracked_seam.sh
