#!/bin/sh
# tools/fixtures/c/counsel_flow_scan.sh -- the counsel-flow descriptor is lawful Brix.
# Orchestrated by tools/gen/chapter/counsel_flow_witness.rish.
#
...
set -eu
f="${1:-tools/gen/chapter/counsel_flow.brix}"
