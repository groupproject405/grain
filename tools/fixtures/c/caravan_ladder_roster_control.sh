#!/bin/sh
# tools/fixtures/c/caravan_ladder_roster_control.sh -- the ladder-roster guard, proven from both sides.
#
...
#
# Run from the repository root:  sh tools/fixtures/c/caravan_ladder_roster_control.sh
set -eu

SCAN=tools/fixtures/c/caravan_ladder_roster_scan.sh
PEN=$(mktemp -d)
