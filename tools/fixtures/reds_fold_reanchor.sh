#!/bin/sh
# tools/fixtures/reds_fold_reanchor.sh -- re-anchor a REDS row's links as it moves one level down.
#
...
#
#   sh tools/fixtures/reds_fold_reanchor.sh < rows.txt > rows-reanchored.txt
#
