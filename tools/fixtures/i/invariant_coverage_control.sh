#!/bin/sh
# tools/fixtures/i/invariant_coverage_control.sh -- prove the proof/contract bin by doing.
#
...
#
# USAGE
#   sh tools/fixtures/i/invariant_coverage_control.sh
#
# Run from the repository root.

set -u

scan=tools/fixtures/i/invariant_coverage_scan.sh
...
read_bins() { ( cd "$pen" && INVARIANT_ROOT=. sh tools/fixtures/i/invariant_coverage_scan.sh 2>&1 ); }
