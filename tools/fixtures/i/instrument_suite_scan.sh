...
#
#   sh tools/fixtures/i/instrument_suite_scan.sh           # living green
#   sh tools/fixtures/i/instrument_suite_scan.sh prove-red  # must exit 1
#
...
run_sh sundial tools/fixtures/s/sundial.sh '^band=green$'
run_sh fascia_metric tools/fixtures/f/fascia_metric_v0.sh '^GREEN: fascia-metric-v0'
run_rishi census_control tools/gen/chapter/census_control_witness.rish 'GREEN: census-control'
run_rishi shed_census tools/gen/chapter/shed_census_witness.rish 'GREEN: shed-census'
run_rishi e111_dialect tools/equinox/witness/equinox_e111_date_dialect_witness.rish 'GREEN: e111-date-dialect'
run_rishi oldness tools/gen/chapter/oldness_census_witness.rish 'GREEN: oldness-census'
run_rishi h1_fence tools/gen/chapter/radiant_h1_fence_witness.rish 'GREEN: radiant-h1-fence'
run_sh radiant_lint tools/fixtures/r/radiant_lint_scan.sh 'planted bare-but counted'
run_sh e113_fascia_health tools/fixtures/e/equinox_e113_fascia_health_scan.sh '^e113_fascia_health=ok$'
run_rishi thing_not_name tools/gen/chapter/thing_not_name_witness.rish 'GREEN: thing-not-name'
