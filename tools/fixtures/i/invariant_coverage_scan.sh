#!/bin/sh
# tools/fixtures/i/invariant_coverage_scan.sh -- a seated law, measured for the first time.
#
...
# tools/fixtures/i/invariant_coverage_control.sh runs 15 behaviors on planted modules in a throwaway
