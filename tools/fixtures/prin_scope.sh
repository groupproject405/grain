...
# Living pin — migrate to tools/prin_scope.rish planned Generator Chapter s1+
set -euo pipefail
...
Prin scope — seasons · Tally · rish vocabulary
  ...
  innermost: MUR Chapter — PAUSED at u91 complete / u92 next (fascia prune · shred RED)
  core:   Gren Chapter — CLOSED · handed back · lean-16 complete
  fund_triad: Murr · Gren · Siya (living)
  quint:  Keeh Chapter — CLOSED · handed back
  sext:   Generator Chapter — OPEN · s0 complete / s1 next (Glow·Rishi·generators)
  ...
  geode:  Geode Chapter — PREP · d0 next (docs-geode · crush=compile · wave=year)
