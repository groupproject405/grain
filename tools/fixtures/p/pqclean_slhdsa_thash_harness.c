// tools/fixtures/p/pqclean_slhdsa_thash_harness.c -- the vendored PQClean (vendor/pqclean, CC0-1.0) asked for its OWN prf_addr and thash over
...
// function-for-function rather than only at the top of the scheme. Rung DISC0 of the SLH-DSA ladder (Chapter G -- Cryptography).
//
