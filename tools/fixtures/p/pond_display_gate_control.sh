#!/bin/sh
# tools/fixtures/p/pond_display_gate_control.sh -- the display gate, proven from both sides.
#
# WHY (REDS %173). tools/fixtures/p/pond_build_drawn_terminal.sh used to print
...
#
# USAGE
#   sh tools/fixtures/p/pond_display_gate_control.sh
#
# Driven by tools/p/pond_display_gate_witness.rish. Run from the repository root.

set -u

SCRIPT=tools/fixtures/p/pond_build_drawn_terminal.sh
faults=0
