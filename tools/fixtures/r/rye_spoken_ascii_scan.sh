...
#   sh tools/fixtures/r/rye_spoken_ascii_scan.sh --list       # the forty worst, then list_shown, list_hidden, list_total
#   sh tools/fixtures/r/rye_spoken_ascii_scan.sh --list-all   # every file and its count, worst first -- no row dropped
#
