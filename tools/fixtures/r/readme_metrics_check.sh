#!/bin/sh
# tools/fixtures/r/readme_metrics_check.sh -- is a file's metrics block still true?
#
...
#
# USAGE
#   sh tools/fixtures/r/readme_metrics_check.sh <file>
#
...
scan="$(sh tools/fixtures/r/readme_metrics_scan.sh </dev/null)"
