#!/bin/sh
# tools/fixtures/r/reds_row_present.sh -- is REDS row N recorded anywhere in the ledger's spine?
#
...
# tools/fixtures/r/reds_ledger_monotone_scan.sh: the elder table line opening on a digit cell, and
...
#
# USAGE
#   sh tools/fixtures/r/reds_row_present.sh 42        # exit 0 when the spine holds row 42
#   sh tools/fixtures/r/reds_row_present.sh 42 --say  # and print where it was found
#   REDS_SPINE_GLOB=... sh tools/fixtures/r/reds_row_present.sh 42   # for a control's pen, honored
#                                                                  # by tools/fixtures/r/reds_spine_files.sh
#
...
# The spine's file set is spelled ONCE, in tools/fixtures/r/reds_spine_files.sh, and both readings
