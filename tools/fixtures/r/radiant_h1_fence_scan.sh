...
#
#   sh tools/fixtures/r/radiant_h1_fence_scan.sh
#   sh tools/fixtures/r/radiant_h1_fence_scan.sh prove-red
#
...
H1_FIXTURE=tools/fixtures/c/census_control_h1_fenced.md
MODE=${1:-}
