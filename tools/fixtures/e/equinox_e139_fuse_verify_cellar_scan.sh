...
#
#   sh tools/fixtures/e/equinox_e139_fuse_verify_cellar_scan.sh
#   sh tools/fixtures/e/equinox_e139_fuse_verify_cellar_scan.sh prove-red
#
...
ELDER_SCAN=tools/fixtures/e/equinox_e138_cellar_accretion_scan.sh
