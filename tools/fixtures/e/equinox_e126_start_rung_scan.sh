...
#
#   sh tools/fixtures/e/equinox_e126_start_rung_scan.sh
#   sh tools/fixtures/e/equinox_e126_start_rung_scan.sh prove-red
#
...
ELDER_STACK=tools/fixtures/e/equinox_e125_build_stack_scan.sh
RISH_ORCH=tools/fixtures/c/census_control_scan.rish
DRIVE=tools/fixtures/c/census_control_scan_drive.sh
H1_SEAM=tools/fixtures/c/census_control_h1_seam.sh
MARKER_SEAM=tools/fixtures/c/census_control_marker_seam.sh
TRACKED_SEAM=tools/fixtures/c/census_control_tracked_seam.sh
ENTRY=tools/fixtures/c/census_control_scan.sh
