...
#
#   sh tools/fixtures/e/equinox_e125_build_stack_scan.sh
#   sh tools/fixtures/e/equinox_e125_build_stack_scan.sh prove-red
#
...
ELDER=tools/fixtures/e/equinox_e123_living_pin_guard_scan.sh
