...
#
#   sh tools/fixtures/e/equinox_e117_fork_extend_breach_close_scan.sh
#   sh tools/fixtures/e/equinox_e117_fork_extend_breach_close_scan.sh prove-red
#
...
MUSEUM=tools/fixtures/b/baton_museum_census_scan.sh
...
ELDER=tools/equinox/witness/equinox_e116_dated_one_definition_witness.rish
