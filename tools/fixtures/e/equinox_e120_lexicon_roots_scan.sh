...
#
#   sh tools/fixtures/e/equinox_e120_lexicon_roots_scan.sh
#   sh tools/fixtures/e/equinox_e120_lexicon_roots_scan.sh prove-red
#
...
ELDER=tools/equinox/witness/equinox_e119_close_seat_surfaces_witness.rish
