#!/bin/sh
# tools/fixtures/e/empty_document_control.sh -- prove the empty-document reading by doing.
#
# WHY. A guard that cannot red guards nothing (REDS row 59). This control builds git repositories
# in a temporary pen, plants one condition in each, runs tools/fixtures/e/empty_document_scan.sh
...
#
# USAGE
#   sh tools/fixtures/e/empty_document_control.sh
#
# Driven by tools/e/empty_document_witness.rish. Run from the repository root.

set -u

scan=$(pwd)/tools/fixtures/e/empty_document_scan.sh
