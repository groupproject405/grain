...
#
#   sh tools/fixtures/e/equinox_e119_close_seat_surfaces_scan.sh
#   sh tools/fixtures/e/equinox_e119_close_seat_surfaces_scan.sh prove-red
#
...
CH5_SCAN=tools/fixtures/e/equinox_ch5_surface_scan.sh
CH6_SCAN=tools/fixtures/e/equinox_ch6_surface_scan.sh
