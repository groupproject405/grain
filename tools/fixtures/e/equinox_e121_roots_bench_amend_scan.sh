...
#
#   sh tools/fixtures/e/equinox_e121_roots_bench_amend_scan.sh
#   sh tools/fixtures/e/equinox_e121_roots_bench_amend_scan.sh prove-red
#
...
ELDER=tools/equinox/witness/equinox_e120_lexicon_roots_witness.rish
