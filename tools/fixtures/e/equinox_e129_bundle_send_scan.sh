...
#
#   sh tools/fixtures/e/equinox_e129_bundle_send_scan.sh
#   sh tools/fixtures/e/equinox_e129_bundle_send_scan.sh prove-red
#
...
ELDER_E128=tools/fixtures/e/equinox_e128_class_o_word_scope_scan.sh
