...
#
#   sh tools/fixtures/d/dated_pattern_scan.sh           # living green
#   sh tools/fixtures/d/dated_pattern_scan.sh prove-red  # must exit 1
#
...
DATED=tools/fixtures/2/20260731-150648_fascia_health_dated_control.md
