...
#
#   sh tools/fixtures/d/date_dialect_scan.sh           # living green path
#   sh tools/fixtures/d/date_dialect_scan.sh prove-red  # must exit 1
#
...
MODE=${1:-}
C1=tools/fixtures/d/date_dialect_control_hyphenated.md
C2=tools/fixtures/d/date_dialect_control_compact.md
