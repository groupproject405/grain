#!/bin/sh
# tools/fixtures/d/document_mirror_scan.sh -- a document declared to live in several homes holds the
...
#
# USAGE
#   sh tools/fixtures/d/document_mirror_scan.sh              # report
#   sh tools/fixtures/d/document_mirror_scan.sh write        # copy canonical over every mirror
#   sh tools/fixtures/d/document_mirror_scan.sh report <descriptor>   # a pen's own descriptor
#
