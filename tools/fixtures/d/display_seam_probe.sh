#!/bin/sh
# tools/fixtures/d/display_seam_probe.sh -- does this machine carry a graphical link seam?
#
...
#
# USAGE
#   sh tools/fixtures/d/display_seam_probe.sh                 # wayland-client and xkbcommon
#   sh tools/fixtures/d/display_seam_probe.sh wayland-client  # only the named seams
#
# Proven both ways by tools/fixtures/p/pond_display_gate_control.sh, driven by
