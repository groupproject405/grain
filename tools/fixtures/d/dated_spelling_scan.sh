#!/bin/sh
# tools/fixtures/d/dated_spelling_scan.sh -- one shape for a dated name, spelled the same way in
...
#
# NOT tools/fixtures/d/dated_pattern_scan.sh, which stands beside it and does a different job:
# that one proves the shared classifier tools/fixtures/d/dated_classify.rish agrees with the law at
