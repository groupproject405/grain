#!/bin/sh
# tools/fixtures/d/dated_path_repoint_scan.sh -- repoint LIVING files at a folded room's new paths.
#
...
# references went silently unrepointed while `tools/fixtures/d/dated_path_scan.sh` -- whose regex
...
#
# USAGE
#   sh tools/fixtures/d/dated_path_repoint_scan.sh          # dry run -- reports, touches nothing
#   sh tools/fixtures/d/dated_path_repoint_scan.sh apply    # rewrite the living files
#
