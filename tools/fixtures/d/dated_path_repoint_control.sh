#!/bin/sh
# tools/fixtures/d/dated_path_repoint_control.sh -- the repointer proven on a tree with a known answer.
#
# WHY. tools/fixtures/d/dated_path_repoint_scan.sh EDITS FILES. Its whole safety rests on one rule --
...
cd "$work"
sh "$root/tools/fixtures/d/dated_path_repoint_scan.sh" apply > /dev/null 2>&1 || true
