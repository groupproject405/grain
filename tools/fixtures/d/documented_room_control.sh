#!/bin/sh
# tools/fixtures/d/documented_room_control.sh -- the invisible-room check, proven both ways.
#
...
code=0
out=$(sh "$root/tools/fixtures/d/documented_room_scan.sh" 2>/dev/null) || code=$?
