#!/bin/sh
# tools/fixtures/reds_spine_derive_scan.sh -- the derived spine: a row's key is its stamp,
...
#
#   sh tools/fixtures/reds_spine_derive_scan.sh                  # read, change nothing
#   sh tools/fixtures/reds_spine_derive_scan.sh --next           # print the number to book next
#   REDS_ANOINTED=xy/main sh tools/fixtures/reds_spine_derive_scan.sh
