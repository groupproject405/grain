// tools/fixtures/m/monocypher_x25519_harness.c — the vendored Monocypher (vendor/monocypher, CC0/BSD-dual), compiled and asked for its OWN X25519
...
// door (crypto/kumara_sealed.rye) rests on. Chapter G (Cryptography · Rye-native, Monocypher-parity, audit-ready).
//
