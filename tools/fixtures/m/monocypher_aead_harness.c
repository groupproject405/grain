// tools/fixtures/m/monocypher_aead_harness.c — the vendored Monocypher (vendor/monocypher, CC0/BSD-dual), compiled and asked for its OWN
...
// TARGET made real for the authenticated-encryption seal Lotus's signed carry, Vault, and Comlink will reach for. Chapter G (Cryptography ·
