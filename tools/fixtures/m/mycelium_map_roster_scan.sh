#!/bin/sh
# tools/fixtures/m/mycelium_map_roster_scan.sh -- the map a reader enters Mycelium by reaches every module.
#
...
#
# USAGE
#   sh tools/fixtures/m/mycelium_map_roster_scan.sh              # census -- key=value lines
#   sh tools/fixtures/m/mycelium_map_roster_scan.sh list         # every fault, one per line
#   sh tools/fixtures/m/mycelium_map_roster_scan.sh census DIR   # read DIR rather than mycelium/
#
