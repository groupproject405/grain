// tools/fixtures/m/monocypher_blake2b_var_harness.c — the vendored Monocypher (vendor/monocypher, CC0/BSD-dual), compiled and asked for its OWN
...
// variable-output mode Argon2's blake2b_long chain and RFC 9106 key derivation lean on. Chapter G (Cryptography · Rye-native, Monocypher-parity).
//
