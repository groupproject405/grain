// tools/fixtures/m/monocypher_blake2b_keyed_harness.c — the vendored Monocypher (vendor/monocypher, CC0/BSD-dual), compiled and asked for its OWN
...
// can forge, the mode Grain's per-record authentication and key derivation reach for. Chapter G (Cryptography · Rye-native, Monocypher-parity).
//
