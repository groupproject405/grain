/* tools/fixtures/m/microkernel_cap_stub.c -- a capability-IPC-SHAPED C stub, authored here, standing in for the kind of C library a
 * capability microkernel exposes to its root task. Rung of the Microkernel Target arc's Equinox 3 question (Chapter G's neighbour arc).
 *
