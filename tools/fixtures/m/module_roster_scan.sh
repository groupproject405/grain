#!/bin/sh
# tools/fixtures/m/module_roster_scan.sh -- the module roster names every module beside it.
#
...
#
# USAGE
#   sh tools/fixtures/m/module_roster_scan.sh                 # census over image/ -- key=value lines
#   sh tools/fixtures/m/module_roster_scan.sh list            # every fault in image/, one per line
#   sh tools/fixtures/m/module_roster_scan.sh census lotus    # census over lotus/
#   sh tools/fixtures/m/module_roster_scan.sh list lotus      # every fault in lotus/
#
