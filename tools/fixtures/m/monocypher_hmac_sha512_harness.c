// tools/fixtures/m/monocypher_hmac_sha512_harness.c — the vendored Monocypher (vendor/monocypher, CC0/BSD-dual), compiled and asked for its OWN
...
// byte-for-byte. The parity TARGET made real for the keyed MAC HKDF-SHA512 and BIP32 key derivation are built on (RFC 2104 / RFC 4231). Chapter G
