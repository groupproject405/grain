// tools/fixtures/m/monocypher_edx_harness.c — the vendored Monocypher (vendor/monocypher, CC0/BSD-dual), compiled and asked for its OWN
...
// sign and agree — the conversion crypto/kumara_sealed.rye's one-key story rests on. Chapter G (Cryptography · Rye-native, Monocypher-parity,
// audit-ready).
//
