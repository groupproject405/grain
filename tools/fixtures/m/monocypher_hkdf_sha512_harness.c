// tools/fixtures/m/monocypher_hkdf_sha512_harness.c — the vendored Monocypher (vendor/monocypher, CC0/BSD-dual), compiled and asked for its OWN
...
// box, and vault key schedule stands on (RFC 5869). Chapter G (Cryptography · Rye-native, Monocypher-parity, audit-ready).
//
