// tools/fixtures/m/monocypher_elligator_harness.c — the vendored Monocypher (vendor/monocypher, CC0/BSD-dual), compiled and asked for its OWN
...
// public key as a uniformly random string — the obfuscated-handshake primitive. Chapter G (Cryptography · Rye-native, Monocypher-parity,
// audit-ready).
//
