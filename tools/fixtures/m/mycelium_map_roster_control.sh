#!/bin/sh
# tools/fixtures/m/mycelium_map_roster_control.sh -- the map-roster guard, proven from both sides.
#
...
#
# Run from the repository root:  sh tools/fixtures/m/mycelium_map_roster_control.sh
set -eu

SCAN=tools/fixtures/m/mycelium_map_roster_scan.sh
PEN=$(mktemp -d)
...
build a "cord cord_kyri purse" "cord purse" "_kyri"
...
build e "cord purse" "cord purse" "_kyri"
...
build f "cord cord_kyri cord_true cord_knot cord_fixture_gen cord_bench" "cord" "_kyri _true _knot _fixture_gen _bench"
...
build g "cord cord_kyri cord_true" "cord" "_kyri"
...
build h "cord cord_relay" "cord" "_kyri _relay"
...
build i "cord orphan" "cord" "_kyri"
...
build k "cord cord_knot cord_knot_bench" "cord cord_knot" "_kyri _knot _bench"
...
build l "cord cord_knot_bench" "cord" "_kyri _knot _bench"
...
build m "cord" "cord borrowed" "_kyri"
...
build o "cord cord_kyri" "cord" "_kyri _relay"
