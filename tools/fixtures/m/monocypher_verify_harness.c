// tools/fixtures/m/monocypher_verify_harness.c — the vendored Monocypher (vendor/monocypher, CC0/BSD-dual), compiled and asked for its OWN
...
// signature-equality check rests on — the piece the two HMAC modules named as an open horizon. Chapter G (Cryptography · Rye-native,
