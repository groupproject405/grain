// tools/fixtures/m/monocypher_xaead_harness.c — the vendored Monocypher (vendor/monocypher, CC0/BSD-dual), compiled and asked for its OWN
...
// crypto_aead_lock, the 24-byte-nonce authenticated encryption Lotus's signed carry, Vault, and Comlink will actually reach for. Chapter G
