// tools/fixtures/m/monocypher_poly1305_harness.c — the vendored Monocypher (vendor/monocypher, CC0/BSD-dual), compiled and asked for its OWN
...
// flagship (crypto/aead.rye, crypto/xchacha20.rye) and every Vault/Comlink/Lotus sealed carry rest on. Chapter G (Cryptography · Rye-native,
