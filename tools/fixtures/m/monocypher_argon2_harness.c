// tools/fixtures/m/monocypher_argon2_harness.c — the vendored Monocypher (vendor/monocypher, CC0/BSD-dual), compiled and asked for its OWN
...
// parity TARGET made real for the memory-hard password KDF Vault's seal rests on. Chapter G (Cryptography · Rye-native, Monocypher-parity,
