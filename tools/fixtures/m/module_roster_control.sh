#!/bin/sh
# tools/fixtures/m/module_roster_control.sh -- the module-roster guard, proven from both sides.
#
# ONE PEN, ANY DIRECTORY. This proves tools/fixtures/m/module_roster_scan.sh, which reads
...
#
# Run from the repository root:  sh tools/fixtures/m/module_roster_control.sh
set -eu

SCAN=tools/fixtures/m/module_roster_scan.sh
PEN=$(mktemp -d)
