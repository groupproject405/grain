// tools/fixtures/m/monocypher_chacha20_harness.c — the vendored Monocypher (vendor/monocypher, CC0/BSD-dual), compiled and asked for its OWN ChaCha20
...
// AEAD, Vault seal, and Comlink session enciphers against. Chapter G (Cryptography · Rye-native, Monocypher-parity, audit-ready).
//
