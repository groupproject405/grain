// tools/fixtures/m/monocypher_sha512_harness.c — the vendored Monocypher (vendor/monocypher, CC0/BSD-dual), compiled and asked for its OWN SHA-512
...
// and the BIP32 seed derivation fold their inputs through. Chapter G (Cryptography · Rye-native, Monocypher-parity, audit-ready).
//
