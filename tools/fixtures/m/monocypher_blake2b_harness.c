// tools/fixtures/m/monocypher_blake2b_harness.c — the vendored Monocypher (vendor/monocypher, CC0/BSD-dual), compiled and asked for its OWN
...
// running on metal. Chapter G (Cryptography · Rye-native, Monocypher-parity, audit-ready).
//
