// tools/fixtures/m/monocypher_ed25519_harness.c -- the vendored Monocypher (vendor/monocypher, CC0/BSD-dual), compiled and asked for its OWN Ed25519
...
// record) rests on. Chapter G (Cryptography, Rye-native, Monocypher-parity, audit-ready).
//
