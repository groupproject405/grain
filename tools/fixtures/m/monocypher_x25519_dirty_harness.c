// tools/fixtures/m/monocypher_x25519_dirty_harness.c — the vendored Monocypher (vendor/monocypher, CC0/BSD-dual), compiled and asked for its OWN
...
// representative is uniformly random (the obfuscated-handshake key-hiding primitive). Chapter G (Cryptography · Rye-native, Monocypher-parity,
// audit-ready).
//
