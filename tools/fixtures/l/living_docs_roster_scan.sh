#!/bin/sh
# tools/fixtures/l/living_docs_roster_scan.sh -- the meter's own roster is a roster.
#
# WHY. tools/fixtures/l/living_docs_lint_roster.sh names which living pages the docs meter reads,
...
#
# USAGE
#   sh tools/fixtures/l/living_docs_roster_scan.sh              # census -- key=value lines
#   sh tools/fixtures/l/living_docs_roster_scan.sh list         # every unrostered and phantom path
#   sh tools/fixtures/l/living_docs_roster_scan.sh census DIR   # read DIR as the root (the pen)
#
...
if [ -f tools/fixtures/l/living_docs_lint_roster.sh ]; then
  ROSTER_SH=tools/fixtures/l/living_docs_lint_roster.sh
else
  ROSTER_SH=roster.sh
fi
