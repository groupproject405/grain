#!/bin/sh
# tools/fixtures/l/loop_prompt_parse_scan.sh -- every shell command this tree prints for a hand to
# paste must parse as a shell command.
#
# WHY. tools/l/launch-claude-chapter.rish prints the unattended-loop recipe: long single-quoted
...
#
# USAGE
#   sh tools/fixtures/l/loop_prompt_parse_scan.sh                 # report on the real recipe
#   sh tools/fixtures/l/loop_prompt_parse_scan.sh report <file>   # report on a pen's own printout
#
