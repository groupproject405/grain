#!/bin/sh
# tools/fixtures/l/loop_prompt_parse_control.sh -- prove the printed-command guard from both sides.
#
...
#
#   sh tools/fixtures/l/loop_prompt_parse_control.sh
#
...
scan="sh tools/fixtures/l/loop_prompt_parse_scan.sh report"
ok=0
bad=0
