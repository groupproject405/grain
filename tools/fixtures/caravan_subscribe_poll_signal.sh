#!/bin/sh
# SIGTERM probe for caravan_subscribe_poll_signal.rish -- send the supervisor a real signal
...
# writing, and reported RED about a supervisor that stops correctly every time (REDS %289).
#
