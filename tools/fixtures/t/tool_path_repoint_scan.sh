#!/bin/sh
# tools/fixtures/t/tool_path_repoint_scan.sh -- repoint LIVING files at the tools fold's new paths.
#
...
# repointed and testimony is resolved, exactly as tools/fixtures/d/dated_path_repoint_scan.sh does
...
#
# USAGE
#   sh tools/fixtures/t/tool_path_repoint_scan.sh          # dry run -- reports, touches nothing
#   sh tools/fixtures/t/tool_path_repoint_scan.sh apply    # rewrite the living files
#
...
# that taught it. tools/fixtures/d/dated_path_exclusions.sh names what the DATED-path tools decline
