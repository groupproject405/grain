#!/bin/sh
# tools/fixtures/t/tool_path_control.sh -- prove the fold-shape scan from both sides.
#
# WHY. `tools/fixtures/t/tool_path_scan.sh` reads a room's fold shape and reports `rooms_over_bound`
...
#
# USAGE
#   sh tools/fixtures/t/tool_path_control.sh
#
...
#
# Kin: tools/tool_path_witness.rish (the rung that runs this) and tools/fixtures/t/tool_path_scan.sh
# (the scan under test).
#
...
scan="tools/fixtures/t/tool_path_scan.sh"
