...
#
#   sh tools/fixtures/t/thing_not_name_scan.sh           # living green
#   sh tools/fixtures/t/thing_not_name_scan.sh prove-red  # must exit 1
#
...
MODE=${1:-}
EMITTER=tools/fixtures/t/thing_not_name_emitter.sh
SHED=tools/fixtures/s/shed_census_scan.sh
HEALTH=tools/fixtures/f/fascia_health_scan.sh
