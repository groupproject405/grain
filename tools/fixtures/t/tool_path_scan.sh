#!/bin/sh
# tools/fixtures/t/tool_path_scan.sh -- measure a room's first-letter fold shape.
#
...
#
# USAGE
#   sh tools/fixtures/t/tool_path_scan.sh              # measure tools/ at the seated bound of 256
#   sh tools/fixtures/t/tool_path_scan.sh <room>       # measure another room
#   sh tools/fixtures/t/tool_path_scan.sh <room> <n>   # ... at another bound
#
