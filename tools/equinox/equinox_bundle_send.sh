...
#
#   sh tools/equinox/equinox_bundle_send.sh rehearsal
#   sh tools/equinox/equinox_bundle_send.sh rehearsal --span HEAD~20..HEAD
#   sh tools/equinox/equinox_bundle_send.sh closing e255
#   sh tools/equinox/equinox_bundle_send.sh wave q64
#   sh tools/equinox/equinox_bundle_send.sh prove-red
#
...
sh tools/equinox/equinox_bundle_manifest.sh \
