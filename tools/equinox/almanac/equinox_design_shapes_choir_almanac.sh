...
entry = (
    ...
    "**Ran:** `rishi/bin/rishi run tools/equinox/witness/equinox_design_shapes_choir_witness.rish` · **Stamp:** `"
    + stamp
    + "` · **Witness:** `tools/gen/chapter/design_shapes_census_witness.rish` · scan `tools/fixtures/d/design_shapes_census_scan.sh` · choir `equinox_design_shapes_choir_witness.rish`\n"
