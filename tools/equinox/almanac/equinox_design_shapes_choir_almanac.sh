...
entry = (
    ...
    + stamp
    + "` · **Witness:** `tools/gen/chapter/design_shapes_census_witness.rish` · scan `tools/fixtures/design_shapes_census_scan.sh` · choir `equinox_design_shapes_choir_witness.rish`\n"
