...
entry = (
    ...
    "**Ran:** `rishi/bin/rishi run tools/gen/chapter/tigerbeetle_void_census_witness.rish` · **Stamp:** `"
    + stamp
    + "` · **Witness:** `tools/gen/chapter/tigerbeetle_void_census_witness.rish` · `tools/fixtures/t/tigerbeetle_void_census.sh` · submodule `gratitude/tigerbeetle`\n"
