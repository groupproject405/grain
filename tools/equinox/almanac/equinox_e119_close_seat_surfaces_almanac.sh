...
entry = (
    ...
    "**Ran:** `sh tools/fixtures/e/equinox_e119_close_seat_surfaces_scan.sh` · **Stamp:** `"
    + stamp
    + "` · **Witness:** `tools/equinox/witness/equinox_e119_close_seat_surfaces_witness.rish` · "
    "counsel `counsel/date/20260731/20260731-214426_e119-close-seat-surfaces.md` · "
    "scan `tools/fixtures/e/equinox_e119_close_seat_surfaces_scan.sh`\n"
