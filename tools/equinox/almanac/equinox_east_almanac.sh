...
entry = (
    ...
    "**Ran:** `rishi/bin/rishi run tools/equinox/witness/equinox_east_almanac_witness.rish` · **Stamp:** `"
    + stamp
    + "` · **Witness:** `tools/equinox/witness/equinox_east_almanac_witness.rish` · `tools/equinox/witness/equinox_e1_east_pack_witness.rish`\n"
