...
entry = (
    ...
    "**Ran:** `rishi/bin/rishi run tools/equinox/witness/equinox_voice_roster_choir_witness.rish` · **Stamp:** `"
    + stamp
    + "` · **Witness:** `tools/gen/chapter/voice_roster_witness.rish` · `tools/gen/chapter/voice_roster_negative_witness.rish` · choir `equinox_voice_roster_choir_witness.rish`\n"
