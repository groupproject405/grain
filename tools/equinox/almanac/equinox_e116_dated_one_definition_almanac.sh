...
entry = (
    ...
    "**Ran:** `rishi/bin/rishi run tools/equinox/witness/equinox_e116_dated_one_definition_choir_witness.rish` · **Stamp:** `"
    + stamp
    + "` · **Witness:** `tools/equinox/witness/equinox_e116_dated_one_definition_witness.rish` · "
    "standing `tools/gen/chapter/dated_pattern_witness.rish` · "
    "`tools/gen/chapter/dated_roof_divergence_witness.rish` · "
    "scan `tools/fixtures/d/dated_pattern_scan.sh` · "
    "`tools/fixtures/d/dated_roof_divergence_scan.sh` · "
    "equinox scan `tools/fixtures/e/equinox_e116_dated_one_definition_scan.sh`\n"
