...
entry = (
    ...
    "**Ran:** `rishi/bin/rishi run tools/equinox/witness/equinox_reds_choir_witness.rish` · **Stamp:** `"
    + stamp
    + "` · **Witness:** `tools/gen/chapter/reds_ledger_witness.rish` · `tools/gen/chapter/reds_ledger_monotone_witness.rish` · `tools/gen/chapter/reds_ledger_negative_witness.rish` · choir `equinox_reds_choir_witness.rish`\n"
