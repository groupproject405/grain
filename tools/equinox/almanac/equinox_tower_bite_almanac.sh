...
entry **Ran:** `rishi/bin/rishi run tools/e/edu_tower_frame_bite_witness.rish` · **Stamp:** `{STAMP}` · **Witness:** `tools/e/edu_tower_frame_bite_witness.rish` · `edu/tower/frame_bound_overpush.rye`
