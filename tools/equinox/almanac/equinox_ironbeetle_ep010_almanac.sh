...
entry = (
    ...
    + stamp
    + "` · **Witness:** `tools/gen/chapter/ironbeetle_ep010_census_witness.rish` · scan `tools/fixtures/ironbeetle_ep010_census.sh` · choir `equinox_ironbeetle_ep010_choir_witness.rish`\n"
