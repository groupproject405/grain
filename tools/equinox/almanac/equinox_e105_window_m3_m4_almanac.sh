...
entry = (
    ...
    "**Ran:** `rishi/bin/rishi run tools/equinox/witness/equinox_e105_window_m3_m4_choir_witness.rish` · **Stamp:** `"
    + stamp
    + "` · **Witness:** `tools/equinox/witness/equinox_e105_window_m3_m4_witness.rish` · scan `tools/fixtures/e/equinox_e105_window_m3_m4_scan.sh` · choir `equinox_e105_window_m3_m4_choir_witness.rish`\n"
