...
entry = (
    ...
    + stamp
    + "` · **Witness:** `tools/equinox/witness/equinox_e105_window_m3_m4_witness.rish` · scan `tools/fixtures/equinox_e105_window_m3_m4_scan.sh` · choir `equinox_e105_window_m3_m4_choir_witness.rish`\n"
