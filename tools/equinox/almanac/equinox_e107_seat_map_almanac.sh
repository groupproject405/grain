...
entry = (
    ...
    "**Ran:** `rishi/bin/rishi run tools/equinox/witness/equinox_e107_seat_map_choir_witness.rish` · **Stamp:** `"
    + stamp
    + "` · **Witness:** `tools/equinox/witness/equinox_e107_seat_map_witness.rish` · scan `tools/fixtures/e/equinox_seat_map_scan.sh` · pin `construction/EQUINOX_SEAT_MAP.md`\n"
