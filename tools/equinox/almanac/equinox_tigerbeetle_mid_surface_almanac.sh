...
entry = (
    ...
    "**Ran:** `rishi/bin/rishi run tools/equinox/witness/equinox_tigerbeetle_mid_surface_witness.rish` · **Stamp:** `"
    + stamp
    + "` · **Witness:** `tools/equinox/witness/equinox_tigerbeetle_mid_surface_witness.rish`\n"
