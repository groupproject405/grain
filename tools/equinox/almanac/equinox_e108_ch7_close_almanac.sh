...
entry = (
    ...
    "**Ran:** `rishi/bin/rishi run tools/equinox/witness/equinox_e108_ch7_close_choir_witness.rish` · **Stamp:** `"
    + stamp
    + "` · **Witness:** `tools/equinox/witness/equinox_e108_ch7_close_witness.rish` · "
    "scan `tools/fixtures/e/equinox_e108_ch7_close_scan.sh` · pin `construction/EQUINOX_SEAT_MAP.md`\n"
