...
entry = (
    ...
    "**Ran:** `rishi/bin/rishi run tools/gen/chapter/tigerstyle_void_return_witness.rish` · **Stamp:** `"
    + stamp
    + "` · **Witness:** `tools/gen/chapter/tigerstyle_void_return_witness.rish` · `gratitude/TIGER_STYLE.md`\n"
