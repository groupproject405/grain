...
entry = (
    ...
    + stamp
    + "` · **Witness:** `tools/gen/chapter/tigerbeetle_sized_types_census_witness.rish` · scan `tools/fixtures/tigerbeetle_sized_types_census.sh` · choir `equinox_tigerbeetle_sized_types_choir_witness.rish`\n"
