...
entry = (
    ...
    + stamp
    + "` · **Witness:** `tools/gen/chapter/ironbeetle_ep042_census_witness.rish` · scan `tools/fixtures/ironbeetle_ep042_census.sh` · choir `equinox_ironbeetle_ep042_choir_witness.rish`\n"
