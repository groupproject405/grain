...
entry = (
    ...
    + stamp
    + "` · **Witness:** `tools/gen/chapter/tigerbeetle_buffer_bleeds_census_witness.rish` · scan `tools/fixtures/tigerbeetle_buffer_bleeds_census.sh` · choir `equinox_tigerbeetle_buffer_bleeds_choir_witness.rish`\n"
