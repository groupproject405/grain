...
entry = (
    ...
    "**Ran:** `rishi/bin/rishi run tools/equinox/witness/equinox_copy_sameness_almanac_witness.rish` · **Stamp:** `"
    + stamp
    + "` · **Witness:** `tools/gen/chapter/copy_sameness_witness.rish` · `tools/gen/chapter/copy_sameness_negative_witness.rish` · choir `equinox_copy_sameness_almanac_witness.rish`\n"
