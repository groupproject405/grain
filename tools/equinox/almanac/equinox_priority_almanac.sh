...
entry = (
    ...
    "**Ran:** `rishi/bin/rishi run tools/equinox/witness/equinox_priority_almanac_witness.rish` · **Stamp:** `"
    + stamp
    + "` · **Witness:** `tools/equinox/witness/equinox_priority_almanac_witness.rish` · `glow/priority_fold_test.rye`\n"
