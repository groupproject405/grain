...
entry = (
    ...
    "**Ran:** `rishi/bin/rishi run tools/equinox/witness/equinox_e110_ch8_reserve_choir_witness.rish` · **Stamp:** `"
    + stamp
    + "` · **Witness:** `tools/equinox/witness/equinox_e110_ch8_reserve_witness.rish` · "
    "scan `tools/fixtures/e/equinox_e110_ch8_reserve_scan.sh` · pin `construction/EQUINOX_SEAT_MAP.md`\n"
