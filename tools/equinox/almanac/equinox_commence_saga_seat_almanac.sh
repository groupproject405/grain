...
entry = (
    ...
    "**Ran:** `rishi/bin/rishi run tools/equinox/witness/equinox_commence_saga_seat_choir_witness.rish` · **Stamp:** `"
    + stamp
    + "` · **Witness:** `tools/gen/chapter/commence_saga_seat_fork_witness.rish` · scan `tools/fixtures/c/commence_saga_seat_fork_scan.sh` · choir `equinox_commence_saga_seat_choir_witness.rish`\n"
