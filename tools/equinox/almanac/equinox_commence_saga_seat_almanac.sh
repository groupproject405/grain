...
entry = (
    ...
    + stamp
    + "` · **Witness:** `tools/gen/chapter/commence_saga_seat_fork_witness.rish` · scan `tools/fixtures/commence_saga_seat_fork_scan.sh` · choir `equinox_commence_saga_seat_choir_witness.rish`\n"
