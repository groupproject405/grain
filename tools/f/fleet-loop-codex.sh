...
# Fleet default selected by Keaton on 20260924. Bakery's seat default is gpt-6-astra.
# Explicit CODEX_MODEL overrides remain supported.
case "$seat" in
  bakery) CODEX_MODEL=${CODEX_MODEL:-gpt-6-astra} ;;
