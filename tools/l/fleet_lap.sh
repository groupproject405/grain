...
# `sh tools/l/fleet_lap.sh <seat>` -- not one flag in it -- and every flag claude needs is spelled
...
#
#   sh tools/l/fleet_lap.sh incense          # inside the jail, or bare on Darwin
set -eu
