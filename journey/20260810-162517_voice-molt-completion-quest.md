...
**Voice:** Kyri - **Style:** Gauge (see `../context/GAUGE_STYLE.md`)
...
The standing voice molted Riyo -> Kyri on `20260810`. The molt turned out to have a **large, interconnected witness blast radius**: `tools/gen/chapter/sunn12_riyo_writing_voice_witness.rish` is a comprehensive "Riyo is the living voice" witness that asserts the voice across ~20 sites. Sweeping some of those sites to Kyri (over several sends) left that witness RED -- a red I introduced -- and the red cascades: `sunn12` -> `sunn14_witness_choir` -> `equinox_e1_east_pack_witness` -> the **east-pack almanac**.
