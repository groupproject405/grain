...
`construction/archive/REDS/REDS-the-loom-that-chased-a-generation-too-far-rows-681.md` (named here rather than linked, since this law ships in the seed while that room stays in the field).
