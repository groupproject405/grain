...
In new prose, rules, session logs, living ledger *Now* lines, and Kyri fields, use **nib** for the **landed-edge** sense of the work:
...
Kyri session logs prefer `product_nib` - `suite_nib` - `git_nib` (or `nib <hash>`) over `tip` / `product_tip`.
