...
**Language:** EN  
**Last updated:** 2026-07-28 (`235520` -- Oven Chapter o1 path cut; module renamed Ember)  
...
Ember names training and fine-tuning on our own corpus (the forge path, named **Anvil** and then **Oven** before it). The catalog folds `.rye` / `.rish` chunks from **our tree** -- gratitude and vendor stay in their reading rooms. Query filters by kind and path prefix. Corpus views fold those hits onto Skate.
