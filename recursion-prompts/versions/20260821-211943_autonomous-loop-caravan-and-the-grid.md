...
**Recipe:** `rishi/bin/rishi run tools/launch-claude-chapter.rish` (prints; the jail launch belongs in the outer terminal)
...
a lap trading lines for delegates shows it rather than looking like a regression. **Chapter G open
