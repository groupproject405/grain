# expanding-prompts season index -- 20260620
...
|---|---|---|
| `20260620-210812` | [10024 - Explicit Width Audit -- `usize` to `u32` / `u64`](20260620/20260620-210812_explicit-width-audit.md) | Expanded at `210812` from the seed: TAME modeled on Tiger Style demands explicitly sized types; our  |
