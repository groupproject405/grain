# Expanding Prompt — Voice Chapter, Journey Two (v16–v31)
...
rishi/bin/rishi run tools/gen/chapter/equinox_e1_east_pack_witness.rish   # 22 sub-witnesses
rishi/bin/rishi run tools/gen/chapter/voice_roster_witness.rish
rishi/bin/rishi run tools/gen/chapter/reds_ledger_witness.rish
...
Eleven nests; only the deepest is OPEN. **Voice Chapter (nest 11, label *undeca* still PROPOSED)** — journey 1 closed at v15; **you open journey 2 at v16**. The Equinox rests PAUSED at e6/e7 (handback `return_equinox_e7`); every nest above is paused; Cursor bench work lands on main and reports verbatim.
