...
SEXT SCOPE (OPEN — walk here):
  Generator Chapter OPEN · s4 complete / s5 next.
  ...
  f4 first cohort LIVE: tools/gen/chapter — prin · prin_scope · prin_ticker · sundial · fascia_metric_v0.
...
report · then walk s5 from the charter:
  ...
  affirm fuse lean · affirm dual-census · affirm tools/gen/chapter LIVE ·
