# The Next-Chapter Build Plan — six briefs, one sequence
...
**Home:** working-tree cut across ~6 living files · **Coupled witness:** `tools/gen/chapter/sunn13_root_survey_witness.rish`
**Stands on:** `work-in-progress/CAIRNS.md` (cairn first) · the sunn13 witness · `prin_scope.rish` · `LICENSE-{MIT,APACHE,CC-BY}` · `MAP.md` · `keys/README.md` · `tools/gen/chapter/personalize.template.brix`
