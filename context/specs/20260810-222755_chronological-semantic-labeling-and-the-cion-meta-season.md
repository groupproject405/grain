...
2. **Semantic** — a drawn **waymark** (a four-letter name from the flw corpus, `.claude/rules/waymark-ladders.md`) or a plain warm word (the Comlink tendency). A season is *the Compass Chapter*, an equinox is *SOON*, not "season 1, equinox 0."
