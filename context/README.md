...
- **`QUIN.md`** — **Quin**, still live in two hats: the **fifth OS variant** (intentionally unpaired, beside Reya · Riyo · Trey · Triz · Trya) and the inference **Q-vane** (Lattice · Scribble · Lantern · Oven). The writing-voice hat passed to Riyo; the note stays here rather than in `archive/` because two of its three subjects remain live. Reya 2 and Rio 3 rest retired in [`archive/`](archive/).
