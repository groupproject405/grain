...
- **`RIYO.md`** -- **Riyo**, the standing voice, seated `20260729.205200` on Keaton's word; one of Grain's own OS variants, paired with Reya. The first Riyo chapter rests in [`archive/`](archive/RIYO.md) as its elder record.
