...
**Chosen path:** `context/baton-museum/` — seated `20260730.030553`. Lexicon row appended. Census witness: `tools/gen/chapter/baton_museum_census_witness.rish` (eleven halls · named elders · `census_breach_count=0` keeps the banked breach unspent). Reconstructed halls remain status-honest until their tree elders are confirmed in a later pass; measurement still beats memory.
