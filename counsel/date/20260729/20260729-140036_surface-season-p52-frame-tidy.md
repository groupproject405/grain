# Surface Chapter p52 — Frame Tidy (Glass · Host Seam)

**Stamp:** `20260729.140036` · **Voice:** Quin · **Chapter:** Surface · **Scope:** sept · **Round:** p52  
...
rishi/bin/rishi run tools/gen/chapter/surface_season_p52_witness.rish
```
