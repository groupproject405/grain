...
**Voice:** Riyo · nested documentary: Trey · **Nest:** deca · Equinox Chapter · e7
**Basis:** tip `ae8780ae39` · origin and xykj61 agree
**Destination:** `context/equinox_map.brix` · `tools/gen/chapter/equinox_map_witness.rish` — **GREEN** bench seat `20260730.113507`
