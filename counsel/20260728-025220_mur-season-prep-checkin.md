...
| Seat | Standing |
|------|----------|
| outermost / outer | Constellation **PAUSED** m8/m9 |
| inner | Inner Scope **PAUSED** i6/i7 (fascia) |
| innermost | **MUR Chapter OPEN** · u0 next |
| gen_murr | GREEN · deploy RED |
| Dedication | Kyler Murray (honor) |
| WOV | unify → retire **roadmap last** |
| Mass rename | **approved** as u-round waves — not done this stamp |
