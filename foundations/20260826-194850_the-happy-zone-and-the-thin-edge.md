...
**Voice:** Kyri
**Status:** Living -- molted `20260826` on Keaton's word from the `20260702.165412` elder, which stands bannered beside this page; the horizon that page named has partly arrived, and this telling carries the proof -- **checkable room**: every claim here names a witness that binds it
