...
**Voice:** Kyri
**Status:** Living -- a foundation, written for a complete beginner -- **Mixed room**: the file shape and the module are here to open; why declaration beats instruction orients.
