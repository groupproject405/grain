...
**Status:** Foundations -- the meaning beneath `%siya` the vane and Siya the fund; design language only, every threshold and coin held exactly as the [constellation paper](../active-designing/date/20260727/20260727-142516_the-constellation-and-the-twelve-funds.md) parks them -- **Vision room**: design language only, with every threshold and coin parked where the constellation paper left them.
