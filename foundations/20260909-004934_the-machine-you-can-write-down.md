...
**Rule:** [`.claude/rules/declared-host-config.md`](../.claude/rules/declared-host-config.md) - **Twin:** [`.cursor-archive/rules/declared-host-config.mdc`](../.cursor-archive/rules/declared-host-config.mdc)
