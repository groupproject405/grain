...
| **Breach — loadable skies, lap 1** — `topology.rye` parameterized: a `Sky` struct + two seated skies (`compass_sky` 12·5·12, `council_sky` 15·3·9/d27/465); free `decode`/`encode` delegate to `compass_sky`; council round-trips every point; six JARL witnesses stay GREEN | breach | **LANDED** `20260810` (`comlink/topology.rye`) |
