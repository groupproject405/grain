...
**Season:** Framework · EDT · **Grain** · **finishing edge:** **sept Surface** — p39 resume **SEATED** / p40 next · Oven **PAUSED** o3/o4 · `oven/` LIVE · Generator **PAUSED** s8/s9 · MUR **PAUSED** u91/u92 · handback `return_generator_s9` · Geode PREP · OS horizon PARK · F undisturbed. Prefer **git nib**. · `prin scope`
...
**Oven Season (oct)** **PAUSED** o3/o4 — path cut LIVE · handed back `return_surface_p39`.  
...
| **Oven Season** | **PAUSED** o3/o4 · handback seated |
