...
**Season:** Framework · EDT · **Grain** · **finishing edge:** **oct Oven** — o3 **SEATED** / o4 next · path-residual queue **empty** · `oven/` LIVE · Surface **PAUSED** p38/p39 · Generator **PAUSED** s8/s9 · MUR **PAUSED** u91/u92 · handback `return_surface_p39` · Geode PREP · OS horizon PARK · F undisturbed. Prefer **git nib**. · `prin scope`
...
| Door | Kind |
|------|------|
| **Oven Season o4+** | **OPEN** · path-residual queue empty · handback or new named door |
