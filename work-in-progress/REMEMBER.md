...
**Last refreshed:** `20260719.233050` (Eastern) · voice Quin  
**Product nib:** ZETA6 · LULU0–5 · **SETU6.5** · HOLD0–HOLD1 · HOLD-W  
**Language nib:** **STOA0–97** GREEN · STOA98 open  
**Suite nib:** ZETA0–6 · LULU0–5 · SETU0–SETU6.5 · HOLD0–HOLD1 · HOLD-W · STOA0–97  
**Git nib:** (refresh after send) STOA97 token→MoldSpec G4  
...
**STOA97** GREEN · `rune_mold.parse_source` walks tokens → `MoldSpec` (G4 close).  
**STOA98** next — check-in (G5 Nock note · Sala B0 · bartis / next language).
...
Hold on iOS: G5 Nock note · bartis. Defer Pixel/SETU / Sala B0 adb to Framework.
...
| **STOA** | Glow language SLC · nest · composition | **STOA0–97 GREEN** · STOA98 next |
...
| Door | Kind |
|------|------|
| **STOA98** G5 Nock note · Sala B0 · bartis / next language | **check-in** — iOS season |
