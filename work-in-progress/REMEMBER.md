...
Seated ladders: **HAWM · TUBE · ZETA · JABS · LULU · STOA · SETU · SUNN · POLE** (elder) · **SOON · JARL · BUHR · TACT** (Compass Chapter). Draw before you number: `.claude/rules/waymark-ladders.md` · `tools/waymark_derive.rish`. Claims: `waymarks/`.
