...
**Chapter:** Framework · EDT · **Grain** umbrella · pier **`~/grain`** · **finishing edge:** Claude on doorway Status · then instrumented COLD cost table · then H Brix survey · breach two next season.
