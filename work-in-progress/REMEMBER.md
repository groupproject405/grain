...
**Git nib:** (pin after send) · Grain · The Tensegral Chapter open · autoproject96/grain
...
**Chapter:** Framework · EDT · **Grain** umbrella · pier **`~/grain`** · **finishing edge:** Tensegral prep (Expanded · Prim · Rish · Realidream · Pond run) then round 0 bow · Sound closed/seated. Prefer **git nib** (never tip) for HEAD.
