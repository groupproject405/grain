...
**Chapter:** Framework · EDT · **Grain** umbrella · pier **`~/grain`** · **finishing edge:** Tensegral **closed and seated** · next = send seat package · then next season charter · Sound seated. Prefer **git nib** (never tip) for HEAD.
