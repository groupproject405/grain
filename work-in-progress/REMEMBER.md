...
**Chapter:** Framework · EDT · **Grain** umbrella · pier **`~/grain`** · **finishing edge:** Tensegral **Arc II exits** · next = Arc III Radiant · Sound closed/seated. Prefer **git nib** (never tip) for HEAD.
