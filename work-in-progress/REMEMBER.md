...
**Chapter:** Framework · EDT · **Grain** umbrella · pier **`~/grain`** · **finishing edge:** Tensegral **Arc IV exits** · next = Arc V Integrated · Sound closed/seated. Prefer **git nib** (never tip) for HEAD.
