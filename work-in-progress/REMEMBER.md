...
**Chapter:** Framework · EDT · **Grain** · **finishing edge:** **undeca** *(canon)* — Voice **OPEN** · Journey 4 **OPEN** (h4 Accrete-never-break) · door 8–11 **GREEN** · next tend three or discovery round-trip · tend two **DONE** · almanac **10/16** · Fascia Equinox **PAUSED** (69→90 · handback CONSUMED) · Equinox **PAUSED** e6/e7 · Surface **PAUSED** · GitHub dual · Riyo stands · Prefer **git nib**. · `prin scope`  
...
**Voice Chapter (undeca, canon)** **OPEN** `20260730.095331` — Journey 4 h4 · door 11 GREEN `myc_perf_pin.rish` · S0 baselines · almanac 10/16 · next tend three or discovery round-trip · tend two DONE · nested handback `return_equinox_e7` when Voice itself returns.  
...
| **Voice Chapter Journey 4** | **OPEN** · A·J4 · h4 · door 8–11 **GREEN** · next tend three or discovery round-trip |
