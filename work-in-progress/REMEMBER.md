...
**Season:** Framework · EDT · **Grain** · **finishing edge:** **sept Surface** — p38 path survey **SEATED** / p39 next · target `oven/` sized · `anvil/` **not cut** · Oven **SEATED** · recursion printout living · transitive crawl **SEATED** · shred RED · Generator **PAUSED** s8/s9 · MUR **PAUSED** u91/u92 · Geode PREP · OS horizon PARK · F undisturbed. Prefer **git nib**. · `prin scope`
...
| Door | Kind |
|------|------|
| **Surface Season p39+** | **OPEN** · cut oven path · pedestals · dated batch · Wayland/live-five |
