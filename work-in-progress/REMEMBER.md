...
**Chapter:** Framework · EDT · **Grain** umbrella · pier **`~/grain`** · **finishing edge:** counsel asks×5 (compiler · perf · Mantra/Weave/nib/Brushstroke · Glow·Sui·Move · `.brush`) · part six twin under Prin · C3–C5 homes · doorway · H. Prefer **git nib** (never tip) for HEAD.
