...
**Git nib:** `815cb7afce` · Grain · **Surface p36** · Oven seated · autoproject96/grain
**Bookmark:** [`counsel/20260728-232511_surface-season-p36-oven-seated.md`](../counsel/20260728-232511_surface-season-p36-oven-seated.md)

**Chapter:** Framework · EDT · **Grain** · **finishing edge:** **sept Surface** — p36 Oven **SEATED** / p37 next · `anvil/` path breach held · transitive crawl **SEATED** · shred RED · Generator **PAUSED** s8/s9 · MUR **PAUSED** u91/u92 · Geode PREP · OS horizon PARK · F undisturbed. Prefer **git nib**. · `prin scope`
...
**Surface Chapter (sept)** seated `20260728.193914` — Shape **B** · Pond Glow GUI · Wayland · Brushstroke/`.brush` · vegan-dogfood · `src/sec` open · `src/web` refused · Genode/SixOS/Nix PARK. Handback `return_generator_s9`.  
**Generator Chapter (sext)** **PAUSED** s8/s9 — handback when resumed `return_mur_u92`.  
**Vocabulary:** **first resident** = routine · **vegan-dogfood** = easter egg · **Oven** = living forge (was Anvil) · [debrided] Anvil tribute kept.
...
**Shred-prep** — [`SHRED_PREP.md`](SHRED_PREP.md) Class H · Oven living · Anvil essay fossils · `anvil/` path held · shred RED.
...
| Door | Kind |
|------|------|
| **Surface Chapter p37+** | **OPEN** · `anvil/` path breach survey · pedestals · dated batch · Wayland/live-five |
| **Oven** | **SEATED** p36 `20260728.232511` · living forge · bread not blades |
