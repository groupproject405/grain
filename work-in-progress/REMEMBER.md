...
**Chapter:** Framework · EDT · **Grain** umbrella · pier **`~/grain`** · **finishing edge:** Tensegral **prep GREEN** · next = round 0 bow via recursion prompt · Sound closed/seated. Prefer **git nib** (never tip) for HEAD.
