...
**Last refreshed:** `20260720.192011` (UTC cloud · Eastern season) · voice Quin  
...
**Git nib:** `08809fc52c` — STOA128 xact-mold flip call-body  
...
**STOA128** sent · xact-mold flip call-body (`XactMold` switch · baked mint/5 → `.send`).  
