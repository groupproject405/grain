...
**Chapter:** Framework · EDT · **Grain** · **finishing edge:** **sept Surface** — p38 path survey **SEATED** / p39 next · target `oven/` sized · `anvil/` **not cut** · Oven **SEATED** · recursion printout living · transitive crawl **SEATED** · shred RED · Generator **PAUSED** s8/s9 · MUR **PAUSED** u91/u92 · Geode PREP · OS horizon PARK · F undisturbed. Prefer **git nib**. · `prin scope`
...
**Shred-prep** — [`SHRED_PREP.md`](SHRED_PREP.md) Class H · Oven living · Anvil essay fossils · `anvil/` path survey seated (not cut) · shred RED.
...
| Door | Kind |
|------|------|
| **Surface Chapter p39+** | **OPEN** · cut oven path · pedestals · dated batch · Wayland/live-five |
...
| **`anvil/` → `oven/` path** | **SURVEY SEATED** p38 · cut waits **approve breach** / **cut oven path** |
