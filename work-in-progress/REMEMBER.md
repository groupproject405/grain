...
**Chapter:** Framework · EDT · **Grain** umbrella · pier **`~/grain`** · **finishing edge:** Inner Scope · **i2 GREEN** · next = i3 close rename-polish · outer **PAUSED** m8/m9. Prefer **git nib** (never tip) for HEAD. · `prin scope`
