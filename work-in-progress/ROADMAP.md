...
| **Fold** | Chapter waypoint + ratification | **SEATED · RATIFIED — arc** |
...
Prove: `tail -4 session-logs/CHAPTERS.md` · `ls counsel/ | grep equinox-season-summary` · `test ! -e active-designing/20260804-230143_the-equinox-season-summary-proposed.md`
