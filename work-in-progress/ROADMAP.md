...
| **Next** | Nona → Oven → Surface → Generator → MUR → … | **PAUSED — by fact** |
| **H** | Hands | **ready** |

Prove: `rg -n "The Voice Chapter" context/LEXICON.md` · `tail -5 session-logs/CHAPTERS.md` · `cat counsel/20260804-232746_e298-the-lookback-audit.md`
