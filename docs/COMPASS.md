...
| 9 | `construction/ITINERARY.md` | Now and season (`TASKS`/`ROADMAP` fused in `20260823.103804`) |
...
Full table: [`context/LEXICON.md`](../context/LEXICON.md), the Cursor loop section.

## Tutorial and markup spine

| Surface | Role |
|---------|------|
| `cursor-and-the-compass.md` | Fossil -- stitched first-day path, retired `20260920.135100` |
