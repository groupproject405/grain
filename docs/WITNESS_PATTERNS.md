...
| Chapter closed (exit bron absent) | `tools/pond_exit_bron_master_seal.sh --season-closed` |

**Law:** landing probes opens no season. Chapter opens only on a named word against a card signed whole. Raw: [`212412`](../active-designing/20260712-212412_pond-scorecard-claude-second-walk.md).
