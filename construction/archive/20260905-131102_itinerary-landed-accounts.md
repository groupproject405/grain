...
**Shelved:** eleven rows -- [`the recital`](REDS-fold-recital.md).
**`%414`-`%416` CLOSED**, whole on the
[wrapper-and-sandbox shelf](REDS-what-a-wrapper-and-a-sandbox-inherit-rows-414-416.md):
...
[a-claim-goes-stale shelf](REDS-a-claim-goes-stale-rows-419-422.md) -- a credential newer by
...
**`%417`/`%418` CLOSED**, on the [what-a-copy-carries shelf](REDS-what-a-copy-carries-rows-417-418.md):
