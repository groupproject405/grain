# Shelved account -- GRASS, the pin-agreement bound (`20260918-092900`)

**Status:** Historical -- shelved whole per [`the-writer-sheds`](../../.claude/rules/the-writer-sheds.md); pointer left on the living card.
...
no ledger row. **YOURS, answered:** the zero-assert ratchet named 4 files, all under `linengrow/` --
`setu65_lab_tx_check.rye`, `setu_desk_hold0_check.rye`, `setu_desk_hold1_check.rye`,
`setu_desk_hold_wayland_check.rye`. The next GRASS account picks up `setu_desk_hold0_check.rye`
from this list.
