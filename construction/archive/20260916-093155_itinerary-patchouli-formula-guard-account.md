# ITINERARY -- the patchouli formula-door account, shelved whole

**Shelved:** `20260916.093155` -- **Status:** Archived, complete, never edited
**Living card:** [`../ITINERARY.md`](../ITINERARY.md) -- **Row:** `construction/REDS.md` %766 stands beside it

*The lap that built `chemical_formula` -- a formula is the most compressed claim a page makes,
and two guards read that page while neither read the claim.*

The account stands here exactly as it was written on the card. It leaves the living card so the
card stays the length a reader will actually read, and its closing question travels forward.

---

**PATCHOULI -- A FORMULA NAMES AN OPERATION, AND NOTHING ASKED WHETHER THE TREE DECLARES IT.**
Elder account [shelved whole](20260916-052706_itinerary-patchouli-formula-door-account.md);
