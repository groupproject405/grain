# ITINERARY -- landed accounts, shelved `20260915.180554`

**Language:** EN
**Status:** Shelf -- immutable once written; the live card holds what is open
**Style:** Gauge, Meter
**Voice:** Kyri
**Room:** checkable -- these completed accounts moved whole from the living card

Folded from [`../ITINERARY.md`](../ITINERARY.md) when its `## Product direction` section
stood at 23,070 bytes, 56 percent of the card. The product direction itself -- Linengrow,
Dimeroll, Tally, Mantra and the product cards -- stayed on the card; these per-ship landed
accounts moved here whole, unedited.
...
[shelved whole](20260913-232140_itinerary-compiler-bytes-account.md).
...
**GRASS -- THE RECEIPT'S TYPE-MARK STANDS WHOLE ON ITS [SHELF](20260913-211721_itinerary-landed-accounts.md).**
...
[shelved](20260913-203500_itinerary-landed-accounts.md); both cache-miss proofs stand.
...
[shelved](20260912-024638_itinerary-landed-accounts.md). **WATER TASTES** (row 3,
...
Elder [shelved](20260912-042043_itinerary-landed-accounts.md).
...
[shelved](20260915-175000_itinerary-diffuser-torus-accounts.md).
...
[shelved](20260912-185030_itinerary-landed-accounts.md). **WATER TASTES** (row 3, N=4698).
...
Elder [shelved](20260912-041905_itinerary-landed-accounts.md).
...
Elder [shelved](20260912-035445_itinerary-landed-accounts.md). **FIRE SEES** (row 2,
