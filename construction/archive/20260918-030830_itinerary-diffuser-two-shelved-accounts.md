# ITINERARY -- two Diffuser accounts shelved whole (the writer sheds)

**Stamp:** `20260918.030830`
**Why shelved:** `the-writer-sheds` (`.claude/rules/the-writer-sheds.md`) holds one live account per
seat on `construction/ITINERARY.md`. Diffuser held two at once when this lap opened a third; both
elder accounts fold here whole, in the same commit that seats the new one.
...
[shelved whole](20260918-015906_itinerary-landed-accounts.md). The prior read of Comlink
