# ITINERARY account -- diffuser: the trade was not a law, and one key walked through it

**Language:** EN
**Style:** Gauge, Meter setting (see [`../../context/GAUGE_STYLE.md`](../../context/GAUGE_STYLE.md))
**Voice:** Kyri
**Status:** Shelf -- immutable once written
**Shelved:** `20260916.070656` from [`../ITINERARY.md`](../ITINERARY.md), whose DIFFUSER section stood 4 bytes under its bound
**Lane:** Diffuser -- moonshots and whitepaper research

The account of the `key_trade` lap, moved here whole so the card could hold the next one. Its links
are written at SHELF depth on arrival rather than repaired afterward: the fold is what breaks a
card-depth link, and REDS `%491` records that the fold's output is stamped, stamped reads as
testimony, and testimony is where every link guard agrees to stop. Six firings of that class have
been repaired by hand; this shelf declines to be the seventh.

---

**DIFFUSER -- THE TRADE WAS NOT A LAW, AND ONE KEY WALKED THROUGH IT.**
Elder [shelved whole](20260916-053304_itinerary-diffuser-grid-flat-account.md).
