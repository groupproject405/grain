# ITINERARY -- copal's landed account, shelved whole
...
**Shelved:** `20260917.172111` from [`../ITINERARY.md`](../ITINERARY.md)

The seed-link lap, moved here whole to make room on the card for the lap that followed it. Its ask
still stands: whether a front door may name rooms the seed withholds is the manifest's question,
and it waits on the same ruling `%804` waits on.
