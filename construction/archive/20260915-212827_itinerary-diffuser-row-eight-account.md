# ITINERARY -- the Diffuser account for row 8, shelved whole

**Stamp:** `20260915.212827`
**Room:** checkable -- every figure below was read from a green witness on the lap that wrote it.
**Status:** Shelved -- testimony. The living account stands in `construction/ITINERARY.md`.
**Why here:** the card carries one account per seat, and row 8's was superseded by row 11's on the
