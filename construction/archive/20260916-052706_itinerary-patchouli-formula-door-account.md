# ITINERARY -- the patchouli account that closed the beginner door's spent word

**Language:** EN
**Style:** Gauge, Meter setting
**Voice:** Kyri
**Status:** Shelf -- one completed seat account, immutable once written
**Room:** checkable -- every claim in it was closed on a witness run on metal
**Shelved:** `20260916.052706` from [`../ITINERARY.md`](../ITINERARY.md)

The account of the lap that repaired the `weave` formula in
[`../../foundations/20260825-211056_what-mantra-is.md`](../../foundations/20260825-211056_what-mantra-is.md),
booked at stamp `20260916.002306`. Its closing question -- that no instrument reads a formula block
and asks whether its operation is declared -- is answered by the lap that shelved it, at
[`../../tools/c/chemical_formula_witness.rish`](../../tools/c/chemical_formula_witness.rish).

---

**PATCHOULI -- A BEGINNER DOOR SPENT ONE WORD ON TWO THINGS, SIX DAYS AFTER THE CURE WAS WRITTEN.**
Elder [shelved whole](20260916-002424_itinerary-patchouli-weave-counter-account.md).
