# Fossil -- GRASS's setu6 device-lab-check account

**Status:** Fossil -- shelved whole from `construction/ITINERARY.md` on `20260918.081500`, per
[`the-writer-sheds`](../../.claude/rules/the-writer-sheds.md). The living card names the pointer;
this page keeps the account's exact words.

**Living page:** [`../ITINERARY.md`](../ITINERARY.md)
