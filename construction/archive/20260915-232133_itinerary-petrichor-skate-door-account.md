# ITINERARY -- the landed Petrichor account, the skate door held to its own declaration

**Language:** EN
**Stamp:** `20260915.232133`
**Status:** Archive shelf -- a completed account lifted whole off `construction/ITINERARY.md`
**Room:** checkable -- every figure below was read off a named instrument on the lap that wrote it
**Voice:** Kyri
...
is carried forward on the card.

---

**PETRICHOR -- A DOOR WHOSE BODY IS A PROOF CENSUS, HELD TO ITS OWN DECLARATION.**
Elder [shelved whole](20260915-223304_itinerary-landed-accounts.md); its open question asks
