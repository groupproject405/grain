# ITINERARY landed accounts -- shelved `20260917.011500`

**Language:** EN
**Status:** Shelf -- one finished patchouli account, kept whole
**Room:** checkable -- every claim names the witness that held it
**Style:** Gauge at Meter
**Voice:** Kyri
**Shelved from:** [`../ITINERARY.md`](../ITINERARY.md)

One receipt, moved off the card by the lap that replaced it.

Its **YOURS** question -- whether an unterminated table and a heading eaten by a list each want a
lap, or whether two walls do -- **stands open and is carried forward unanswered**; nothing on the
replacing lap touched it. So does the elder QA-card ask it was already carrying, on whether a Rishi
witness stating its bounds in `assert ... else` alone should be graded at the door. That one is
claimed as `grass-genre-census-door-meter` and is being measured rather than argued.

---

**PATCHOULI -- THE CARD READ PERFECTLY AND RENDERED AS ONE CODE BLOCK.** Both elder accounts
[shelved whole](20260916-231943_itinerary-landed-accounts.md), the QA-card ask carried
