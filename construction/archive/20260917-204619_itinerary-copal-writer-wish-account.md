# ITINERARY account -- the writer validated its name and wished at the other two fields
...
**Folded:** `20260917.204619` from [`../ITINERARY.md`](../ITINERARY.md), to bring the card back
under its byte bound after a rebase carried peer landings in whole.
