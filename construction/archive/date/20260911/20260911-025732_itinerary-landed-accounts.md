# ITINERARY landed accounts -- shelved `20260911.025732`

**Language:** EN
**Style:** Gauge, Meter setting (see [`../../context/GAUGE_STYLE.md`](../../../../context/GAUGE_STYLE.md))
**Voice:** Kyri
**Status:** Testimony -- the PETRICHOR live-front block as it left `construction/ITINERARY.md`, with its ask printed as it went

**PETRICHOR -- A PEER'S REPAIR, REVERTED BY A COMMIT WITH NO BUSINESS THERE.**
Elder [shelved](20260911-000651_itinerary-landed-accounts.md).
