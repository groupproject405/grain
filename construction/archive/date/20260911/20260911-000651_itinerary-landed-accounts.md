# ITINERARY landed accounts -- shelved `20260911.000651`

**Language:** EN
**Style:** Gauge, Meter setting (see [`../../context/GAUGE_STYLE.md`](../../../../context/GAUGE_STYLE.md))
**Voice:** Kyri
**Status:** Testimony -- the PETRICHOR live-front block as it left `construction/ITINERARY.md`, with its two asks printed as they went

**PETRICHOR -- THE MANUAL NAMES THE CEILING IT IS HELD TO.**
Elder [shelved](../20260910/20260910-223215_itinerary-landed-accounts.md).
