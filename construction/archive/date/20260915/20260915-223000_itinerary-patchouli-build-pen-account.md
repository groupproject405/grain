# ITINERARY -- the Patchouli account: two guards wrote one binary

**Language:** EN
**Style:** Gauge, Meter setting
**Voice:** Kyri
**Status:** Shelf -- one completed account, immutable once written
**Room:** checkable -- every claim in it closed on a witness run on metal
**Shelved:** `20260915.223000` from [`../ITINERARY.md`](../../../ITINERARY.md)

The lap that moved two Mantra guards' builds into their own pens, repaired a day shelf a rebase had
doubled, and folded two rows to make room for a third. Shelved whole so the card carries the live
front rather than a finished receipt.
