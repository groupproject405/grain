# ITINERARY shelf -- copal's written-ASCII account

**Language:** EN
**Status:** Shelf -- a finished account, kept whole
**Room:** checkable -- every figure in it was read by a guard that still runs
**Stamp:** `20260915.223327` (EDT)
**Folded from:** [`../ITINERARY.md`](../../../ITINERARY.md), which stood 168 bytes over its 40,960 bound
with a fresh account landing. A finished section folds to a shelf; the open questions this account
raised stay on the living card, where Keaton reads them.
