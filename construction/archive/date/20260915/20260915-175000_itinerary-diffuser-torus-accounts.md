# ITINERARY shelf -- the Diffuser torus accounts

**Stamp:** `20260915.175000`
**Language:** EN
**Status:** Shelf -- a completed account lifted whole off `construction/ITINERARY.md`, kept as
written. Dated testimony; nothing here is living.
**Voice:** Kyri

The account below stood on the living card until its successor landed. It is moved rather than
rewritten, so the card holds the current reading and the record keeps every word.

---

**DIFFUSER -- THE FALSIFIER FAILED AND THE ROW DIED OF IT.**
Elder [shelved](../20260912/20260912-021711_itinerary-landed-accounts.md).
