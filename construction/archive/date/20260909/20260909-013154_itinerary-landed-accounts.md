# ITINERARY -- landed accounts shelved `20260909.013154`

**Shelf.** Folded from the live front of `construction/ITINERARY.md` to hold that pin
under its declared bound. This account is finished: it names work that landed and was
proven, and the card's live front is for what is still moving.

**BAKERY -- A PEER AND I DIAGNOSED ONE FAULT AND BUILT TWO CURES; MINE WITHDREW.**
Elder [shelved](20260909-000500_itinerary-landed-accounts.md) by a peer; mine duplicated it.
Row [`20260908.234818`](../../REDS/REDS-a-numerator-that-reads-names-rows-655.md), off `%654` once
published.
