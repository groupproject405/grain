# ITINERARY landed accounts -- the PETRICHOR account of `20260908.225856`

**Language:** EN
**Status:** Shelf -- testimony, immutable once written
**Voice:** Kyri

The PETRICHOR account this shelf holds stood on `construction/ITINERARY.md` until the card's
next lap needed the room. Every word is kept; the live card carries the account that replaced it.

---

**PETRICHOR -- A DOCUMENTED FLAG THAT NEVER RETURNS, ON A PAGE GRADED HEALTHY.**
Elder [shelved](../20260908/20260908-230317_itinerary-landed-accounts.md).
