# ITINERARY -- landed accounts shelved `20260909.000500`

**Shelf.** Folded from the live front of `construction/ITINERARY.md` to hold that pin under its
declared bound while a new standfast lands. These accounts are finished: each names work that
...
Elder [shelved](../20260908/20260908-223549_itinerary-landed-accounts.md).
