# ITINERARY landed accounts -- GRASS, shelved `20260909.152755`

**Language:** EN
**Style:** Gauge, Meter setting
**Status:** Shelf -- immutable once written
**Room:** checkable -- the departing live-front block, whole, every path as it stood

The GRASS live front as it stood before the red-leg lap, carried across whole rather than condensed.

---

**GRASS -- A PROVER'S ANSWER WENT UNCOUNTED FOR SPELLING THE WRONG LETTERS.**
Elder [shelved](../20260908/20260908-233325_itinerary-landed-accounts.md).
