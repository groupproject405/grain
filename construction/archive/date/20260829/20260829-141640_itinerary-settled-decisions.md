# ITINERARY settled decisions -- the second shelf, folded `20260829.141640`

**Language:** EN
**Status:** Archived, complete, never edited -- rows moved word for word from the living card
**Living pin:** [`../ITINERARY.md`](../../../ITINERARY.md)
**Checkpoint:** walk-back `e4e80e5677` in [`../CHECKPOINTS.md`](../../../CHECKPOINTS.md)
**Elder shelf:** [`20260824-130807_itinerary-settled-decisions.md`](../20260824/20260824-130807_itinerary-settled-decisions.md)

The card stood at 24,575 of its 24,576 bytes with the LOCA ladder unnamed on it -- the aether
rota lap's finding (`20260829.140140`). These rows are settled, granted, or landed; each is held
here exactly as the card carried it, and the card breathes again.
...
## Open doors -- rows granted or settled
...
| **The pen, the gossip, and the derived spine** -- the %230 answer proposed (stamp-keyed rows, number derived at merge); design and read at `active-designing/20260825-205011` - `external-research/20260825-205011`. The seat stays Keaton's | booked `20260825.205011` -- **since seated as law**: `.claude/rules/derived-spine.md` (`20260827.181605`), witness proven on the real `%292` collision |
...
No lap publishes on a count; gate %1 governs alone (the custody-gates block carries the same
sentence, which is why this section left the card). Testimony:
...
## The Now paragraphs that landed
