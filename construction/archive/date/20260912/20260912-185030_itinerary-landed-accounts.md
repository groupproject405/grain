# ITINERARY -- landed accounts, shelved `20260912.185030`
...
The PETRICHOR account the live card carried before the recovery lap of `20260912.185030`, moved
here whole so the live front holds one account per ship.

---

**PETRICHOR -- A FINISHED ROUND SAT IN THE STASH, AND ITS DOOR PRINTED NO NUMBER.**
Elder [shelved](20260912-033302_itinerary-landed-accounts.md). **WATER TASTES** (row 3,
N=4682, past 2).
