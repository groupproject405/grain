# ITINERARY -- the account of the law page that narrated a ceiling it declares nowhere

**Shelved:** `20260916.073526` -- **Status:** Archived, complete, never edited
**Living card:** [`../ITINERARY.md`](../../../ITINERARY.md) -- **Ledger:** the reading beside it is booked at `REDS %769`
**Room:** checkable -- every reading below was taken on metal and names the instrument that took it.

*Folded whole from the card so the next account fits under the same bound. The card keeps a pointer
line and the open question; this page keeps every word.*

---

**GRASS -- A LAW PAGE NARRATED A CEILING IT DECLARES NOWHERE, AND THE LAST FALL WENT UNSAID FIVE DAYS.**
Elder account [shelved whole](20260916-034934_itinerary-grass-claim-preserve-control-account.md).
