# ITINERARY -- diffuser's landed account, shelved `20260916.221930`

**Room:** checkable -- the account of one landed lap, shelved whole off `../ITINERARY.md` when the next lap's account took its seat. Its two asks travel with it: whose word sets the mode a compiler ships under, and the 2.2x still standing between ReleaseSafe and ReleaseFast. The second half of its MINE -- that rye was never rebuilt to confirm Debug -- is settled by the lap that replaced it.

**DIFFUSER -- THE HASH RUNS IN DEBUG RATHER THAN IN SOFTWARE.**
Elder [shelved whole](20260916-220753_itinerary-landed-accounts.md), its two asks with it.
