# ITINERARY -- the bakery build-receipt key account, shelved whole

**Shelved:** `20260916.082153` -- **Status:** Archived account, complete, never edited
**Living card:** [`../ITINERARY.md`](../../../ITINERARY.md)
**Rows:** [`REDS-a-guards-own-words-and-the-path-that-reached-it-rows-762-764.md`](../../REDS/REDS-a-guards-own-words-and-the-path-that-reached-it-rows-762-764.md)
**Room:** checkable -- every figure below was measured in a throwaway pen and names its witness

The account below stood on the live front while its work landed. Its two ledger rows closed and
folded on the same stamp this file carries, so the receipt for work already finished is one click
away and the card holds the live front.
