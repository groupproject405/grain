# ITINERARY landed accounts -- the diffuser account of `20260916.200848`

**Stamp:** `20260916.211800`
**Language:** EN
**Style:** Gauge, Meter setting
**Voice:** Kyri
**Status:** Archived testimony -- the card's diffuser account as it stood before the perturbation
probe replaced it. Kept whole, links re-anchored for this depth by the writer rather than by hand.
**Room:** Checkable -- every figure it carries was printed by an instrument named in it
...
Elder [shelved whole](20260916-201924_itinerary-landed-accounts.md), its `key_trade` ask with it.
