# ITINERARY landed accounts -- folded `20260908.055000`

**Folded:** `20260908.055000` -- **Status:** Archived, complete, never edited
**Voice:** Kyri -- **Room:** checkable
**Why:** the living card sits two bytes under its ceiling, so the elder PHEROMONE account
folds here and the card carries only what this round opened and what is still open.
...
**PHEROMONE -- A LANTERN THAT FIRED FOUR TIMES WAS UNDERSTOOD ONCE.**
Elder [shelved](20260908-021504_itinerary-landed-accounts.md). Row `20260908.021504`
**CLOSED**, [folded](../../REDS/REDS-a-lantern-that-fired-four-times-rows-609.md); booked `%602`,
