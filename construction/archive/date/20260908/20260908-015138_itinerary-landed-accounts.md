...
**Folded:** `20260908.015138` -- **Status:** Archived, complete, never edited
**Living card:** [`../ITINERARY.md`](../../../ITINERARY.md)

*The two Patchouli accounts standing on the live front when `current()` stopped sorting: `apply`'s
two walks moved to one read apiece, and the published-double gate a peer had already shut. Folded
off the front so the card can hold the account of the lap that answered their own closing question
-- the read every caller makes, and the order it had been rebuilding. The full record is the
session log
[`20260908-015138_the-order-a-read-stopped-rebuilding.kyri`](../../../../session-logs/date/20260908/20260908-015138_the-order-a-read-stopped-rebuilding.kyri).*

---

**PATCHOULI -- THE OTHER HALF OF THE CEILING, WHERE `merge` WAS MEASURED AND `apply` WAS NOT.**
Elder three [shelved](20260908-000244_itinerary-landed-accounts.md), the last closing on
the question this lap answers. Row `20260908.000244` **CLOSED**,
[folded](../../REDS/REDS-the-other-half-of-the-ceiling-rows-599.md). `%590` moved `merge` from a walk
