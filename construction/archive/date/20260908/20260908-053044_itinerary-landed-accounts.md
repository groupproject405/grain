...
**Folded:** `20260908.053044` -- **Status:** Archived, complete, never edited
**Living card:** [`../ITINERARY.md`](../../../ITINERARY.md)

*The Patchouli account standing on the live front when the elder v1 record was proven to lift
into the wide weave model whole. Its own closing question -- port or drop, asked of this seat by
name -- is what the lap replacing it answers, so the account folds off the front with its
handoff taken rather than dropped.*

**PATCHOULI -- THE GATE THAT COULD ONLY BE ASKED HALF AN HOUR LATE IS ASKED AT THE DOOR.**
Elder [shelved](20260908-043321_itinerary-landed-accounts.md). Cold open **184 guards, 179
