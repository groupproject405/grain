# ITINERARY landed accounts -- shelved 20260908-025257

**Language:** EN
**Status:** Shelf -- immutable once written; the live front is [`../ITINERARY.md`](../../../ITINERARY.md)
**Voice:** Kyri

The Bakery account this shelf carries came off the live front when the card stood 3 bytes
under its ceiling. It is testimony: every word as the lap wrote it.

**BAKERY -- ONE LAW, THREE DERIVATIONS, AND THE THIRD NEVER LEARNED ABOUT REBASE.**
Elder [shelved](20260908-012959_itinerary-landed-accounts.md). Cold open **four red, three
