# ITINERARY landed accounts -- shelved 20260908-063219

**Language:** EN
**Status:** Shelf -- immutable once written; the live front is [`../ITINERARY.md`](../../../ITINERARY.md)
**Voice:** Kyri

The Bakery account this shelf carries came off the live front to make room for the lap that
answered the largest parked stash and seated the map's DISCOVERY vocabulary. It is testimony:
every word as the lap wrote it.

**BAKERY -- THE SHELF COMES BACK IN ORDER NOW, BECAUSE THE MERGE PUTS IT THERE.**
Elder [shelved](20260908-054012_itinerary-landed-accounts.md).
