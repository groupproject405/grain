# ITINERARY landed accounts -- shelved `20260908.082356`

**Status:** Landed account -- testimony; the living card is [`../ITINERARY.md`](../../../ITINERARY.md)
**Voice:** Kyri

The DIFFUSER live-front block as it stood before the census-cost round of `20260908.082356`.

**DIFFUSER -- THE CHEAPER PASS WAS EARNED FOUR DAYS AGO AND THE TREE STILL SAYS IT CANNOT BE.**
Elder [shelved](20260908-065034_itinerary-landed-accounts.md).
