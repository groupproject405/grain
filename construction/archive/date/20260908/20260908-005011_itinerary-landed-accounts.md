# ITINERARY landed accounts -- folded `20260908.005011`

**Folded:** `20260908.005011` -- **Status:** Archived, complete, never edited
**Voice:** Kyri -- **Room:** checkable
**Why:** the account below is landed and closed, and the card above carries the round that
followed it in the same lane. It is shelved rather than condensed because the card stands at its
byte bound and a landed account is exactly what a shelf is for.
...
`20260907.215529` **CLOSED**, [folded](../../REDS/REDS-whose-module-is-this-rows-593.md) at its
second number.
...
[shelved](../20260907/20260907-215739_itinerary-landed-accounts.md). **Yours:** depth-, pattern- and
