# ITINERARY landed accounts -- folded `20260908.105623`
...
as it was written, with its two relative links re-anchored a directory deeper. Every claim in it
landed -- `tally_caller_map` reads the derived sixty-nine beside the nineteen named, its control
stands at 32 legs, and the row it names is BOOKED and folded. The one line it left open is the
`tally/README.md` reading of C+ 77, and it stays open: the lap that would have worked that frame
opened on a red instead, so the frame was pushed and preempted rather than closed. It is named
here rather than on the live card, which a red now holds.*

---

**PATCHOULI -- A GUARD READ 19 OF 69, BY A PREDICATE ITS CANON FORBIDS, UNHEARD.**
Elder [shelved](20260908-091217_itinerary-landed-accounts.md). `20260908.091217` **BOOKED**,
[folded](../../REDS/REDS-nineteen-of-sixty-nine-rows-629.md), renumbered twice.
