# ITINERARY -- landed accounts, shelved `20260908.115307`
...
and a landed account goes where landed accounts belong. This block recorded the fold-shelf gate
split -- `FOLD_SHELF_CORPUS` reading `tracked` by default with the witness asserting it by name,
`working` adding every untracked path git does not ignore -- and the peer's row this seat booked and
lifted after `fleet_call --pattern`, typed to ask, killed its own 1,470-second pass.

---

**BAKERY -- A PRESCRIPTION THAT CANNOT FIRE PRESCRIBES NOTHING.**
Elder [shelved](20260908-093634_itinerary-landed-accounts.md). Row `20260908.093634`
**CLOSED**, [folded](../../REDS/REDS-a-prescription-that-cannot-fire-rows-633.md) -- renumbered four
...
([shelf](../../REDS/REDS-the-question-that-sent-rows-628.md)); `dry=yes` was already the default in
