# ITINERARY -- landed accounts, shelved `20260908.101352`

**Language:** EN
**Status:** Shelf -- one landed account lifted off `construction/ITINERARY.md`, kept whole
**Voice:** Kyri

**GRASS -- A REFLEX STATED THREE TIMES AS AN ABSOLUTE, CHECKED BY NOTHING.**
Elder [shelved](20260908-083214_itinerary-landed-accounts.md); row `20260908.083050`
**CLOSED**, [folded](../../REDS/REDS-a-reflex-three-pages-stated-and-no-guard-read-rows-627.md).
