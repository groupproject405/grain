# ITINERARY landed accounts -- folded `20260908.091217`
...
landed -- `caravan/parse_int.rye` is a symlink in the tree, `copy_lag`'s ceiling stands at zero, and
the row it names is CLOSED. The one question it carried for Keaton -- whether that guard's remaining
seat is the prose binding alone -- was ANSWERED by measurement on `20260908.091217` and left the
card with its own account, so it rests here rather than staying open.*

---

**PATCHOULI -- A RATCHET EXISTS TO REACH ZERO, AND ITS CONTROL COULD NOT SURVIVE ZERO.**
Account [shelved](20260908-080144_itinerary-landed-accounts.md) on landing, elder beside
