...
**Folded:** `20260908.031547` -- **Status:** Archived, complete, never edited
**Living card:** [`../ITINERARY.md`](../../../ITINERARY.md)

*The Patchouli account standing on the live front when `annotate`'s own header was read against its
code: `current()` stopped rebuilding an order the weave already held. Folded off the front so the
card can hold the account of the lap that read the function beside it and found the cost claim the
same repair had left behind. The full record is the session log
[`20260908-031547_the-header-that-kept-a-spent-reason.kyri`](../../../../session-logs/date/20260908/20260908-031547_the-header-that-kept-a-spent-reason.kyri).*

---

**PATCHOULI -- THE ORDER A READ HAD BEEN REBUILDING; THE THIRD SHAPE IS REPAIRED.**
Elder two [shelved](20260908-015138_itinerary-landed-accounts.md), the last closing on this
