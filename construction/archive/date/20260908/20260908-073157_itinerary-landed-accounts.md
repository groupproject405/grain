# ITINERARY landed accounts -- shelved 20260908-073157

**Language:** EN
**Status:** Shelf -- immutable once written; the live front is [`../ITINERARY.md`](../../../ITINERARY.md)
**Voice:** Kyri

The Bakery account this shelf carries came off the live front to make room for the lap that gave
`fold_shelf_link` its third correction arm. It is testimony: every word as the lap wrote it.

**BAKERY -- DISCOVERY WAS A WORD THE MAP NEVER SPELLED; 194 GUARDS SHARED ONE SILENCE.**
Elder [shelved](20260908-063219_itinerary-landed-accounts.md).
