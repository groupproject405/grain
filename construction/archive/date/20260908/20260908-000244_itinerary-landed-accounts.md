...
**Folded:** `20260908.000244` -- **Status:** Archived, complete, never edited
**Living card:** [`../ITINERARY.md`](../../../ITINERARY.md)

*The three Patchouli accounts standing on the live front when the weave's second quadratic was
repaired: the `merge` fold that was moved from a walk to a binary search (`%590`), the lap that was
parked three times and landed whole, and the fourth park. Folded off the front so the card can hold
the account of the lap that answered their own closing question -- `apply`'s uniqueness assert, the
same walk one function over. The full record is the session log
[`20260908-000244_the-other-half-of-the-ceiling.kyri`](../../../../session-logs/date/20260908/20260908-000244_the-other-half-of-the-ceiling.kyri).*

---

**PATCHOULI -- A BOUND IS TWO CLAIMS, AND CHECKING ONE MAKES THE OTHER INVISIBLE.**
Elder [shelved](../20260907/20260907-210804_itinerary-landed-accounts.md). Row `20260907.210632`
**CLOSED**, [folded](../../REDS/REDS-a-bound-is-two-claims-rows-590.md). `mantra/src/weave.rye` checked
...
Elder and this lap's recovery both [shelved](../20260907/20260907-191757_itinerary-landed-accounts.md)
