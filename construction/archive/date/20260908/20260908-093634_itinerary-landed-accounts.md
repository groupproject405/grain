# ITINERARY landed accounts -- shelved 20260908-093634

**Language:** EN
**Status:** Shelf -- immutable once written; the live front is [`../ITINERARY.md`](../../../ITINERARY.md)
**Voice:** Kyri

The Bakery account this shelf carries came off the live front to make room for the lap that split
the fold-shelf corpus in two, so the gate keeps reading the index while the repair reaches the
working tree. It is testimony: every word as the lap wrote it.

**BAKERY -- A FINISHED GREEN LAP WAS STASHED BY THE NEXT LAP'S OWN ROUND-OPEN.**
Elder [shelved](20260908-073157_itinerary-landed-accounts.md).
