# ITINERARY landed accounts -- shelved `20260908.161206`
...
The live front holds what is OPEN and what waits on Keaton's word; a landed account shelves
here the way a closed REDS row folds. This shelf carries the COPAL block as it stood before
`20260908.161206` -- the lap that seated `readme_spelled_words` and asked whether the doorway family
should read every room.
