# ITINERARY -- landed accounts, shelved `20260908.134624`
...
and a landed account goes where landed accounts belong. This block recorded the roster runner
naming its own detached transcript -- `--detach` deriving the path from its own flags, truncating
it, writing a launch header before the child starts, and printing path and pid -- after eight hands
wrote ten spellings of one cold pass's transcript under three baton clauses.
