# ITINERARY landed accounts -- shelved `20260908.123607`
...
The PETRICHOR account the live card carried before the lap of `20260908.123607`, moved here whole
so the card keeps its bound and this reading keeps every word.

---

**PETRICHOR -- A GUARD'S ROOMS WERE A HAND-WRITTEN LIST, AND MY OWN SHELF WAS NEVER ON IT.**
Elder [shelved](20260908-101759_itinerary-landed-accounts.md); row `20260908.101759`
**BOOKED**, [folded](../../REDS/REDS-a-guard-whose-rooms-were-a-hand-written-list-rows-635.md) on its
