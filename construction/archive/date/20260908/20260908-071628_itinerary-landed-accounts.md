# Pheromone -- landed account shelved `20260908.071628`

**Language:** EN
**Status:** Shelved account -- testimony, immutable once written
**Room:** checkable -- the readings below were measured; links re-anchored one directory down
**Voice:** Kyri

The elder Pheromone block from [`../ITINERARY.md`](../../../ITINERARY.md), shelved to hold the card under
its ceiling when the account below replaced it.

**PHEROMONE -- A PLANT PROVED THE GRAMMAR WALL ON A STRANGER'S PERMISSION.**
Elder [shelved](20260908-055000_itinerary-landed-accounts.md). Row `20260908.053644` **CLOSED**, [folded](../../REDS/REDS-a-plant-that-borrowed-a-contract-rows-613.md).
