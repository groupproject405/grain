# ITINERARY landed accounts -- folded `20260908.123338`
...
as it was written, with its one relative link re-anchored a directory deeper. What it recorded is
still true -- three round-open stashes hold work the tree has healed around, `stash_record` still
answers `unlanded=3`, and the closing move is still a cut only Keaton may make. The block leaves
this shelf because the lap after it took the OTHER open item it named, `%589`, and the card holds
one block per ship.*

---

**PATCHOULI -- TWO GATES DISAGREE ABOUT A PARKED LAP.**
Elder [shelved](20260908-105623_itinerary-landed-accounts.md). `20260908.105623` **OPEN**,
