# ITINERARY landed accounts -- shelved `20260908.025249`

*The live front's DIFFUSER paragraph as it stood before the first falsifier was run against the
roadmap. Shelved whole rather than condensed, so the account keeps every number it measured.
...
Elder [shelved](20260908-021719_itinerary-landed-accounts.md). `20260905-232224`'s second
