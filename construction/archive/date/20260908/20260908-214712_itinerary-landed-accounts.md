# ITINERARY landed accounts -- shelved `20260908.214712`

**Language:** EN
**Status:** Landed account -- immutable testimony, shelved from `construction/ITINERARY.md`
**Voice:** Kyri

The PATCHOULI live-front block as it stood before the spoken-ASCII lap, kept word for word so the
card could hold the round that followed it. Relative links are re-anchored one directory deeper.

---

**PATCHOULI -- THE STORE SPENDS THE PROOF IT PAID FOR, AND THE CEILING WENT UP.**
Elder [shelved](20260908-190951_itinerary-landed-accounts.md).
