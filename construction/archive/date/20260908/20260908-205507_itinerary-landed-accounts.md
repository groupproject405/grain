# ITINERARY landed accounts -- shelved `20260908.205507`
...
`20260908.205507` -- the lap that repaired the seed allowlist's duplicate row and named every
assert's reason in amphora's six library modules.
