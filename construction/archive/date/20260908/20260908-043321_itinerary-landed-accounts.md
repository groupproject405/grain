...
**Folded:** `20260908.043321` -- **Status:** Archived, complete, never edited
**Living card:** [`../ITINERARY.md`](../../../ITINERARY.md)

*The Patchouli account standing on the live front when `annotate`'s cost paragraph was repaired and
the shell-dialect red closed by a peer's cure. Its own closing handoff -- a pre-commit dialect read
over staged shell -- is the lap that replaces it here, so the account folds off the front with its
next door already walked through. The full record is the session log
...
Elder [shelved](20260908-031547_itinerary-landed-accounts.md). Row `20260908.031547`
