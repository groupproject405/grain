...
**Folded:** `20260908.012959` -- **Status:** Archived, complete, never edited
**Living card:** [`../ITINERARY.md`](../../../ITINERARY.md)

*The Bakery account standing on the live front when the ledger's headline drift found its root: the
`reds_ledger_monotone` gate moved off a class it could not see, the witness that went quiet as it
got more to say, and the `%592` stash reading that a peer superseded with a broader rule six.
Folded off the front so the card can hold the lap that named why the headline drifts at all --
pre-commit rule two reading no debt. The full record is the session log
[`20260908-012959_the-rule-that-never-learned-about-rebase.kyri`](../../../../session-logs/date/20260908/20260908-012959_the-rule-that-never-learned-about-rebase.kyri).*

---

**BAKERY -- ONE LAW, TWO DERIVATIONS, AND THE BLIND ONE HELD THE GATE.**
Elder [shelved](../20260907/20260907-232511_itinerary-landed-accounts.md). Row `20260907.230000`
**CLOSED**, [folded](../../REDS/REDS-a-guard-that-could-not-say-what-it-knew-rows-598.md). Cold open
