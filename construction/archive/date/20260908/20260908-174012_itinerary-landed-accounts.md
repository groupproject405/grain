# ITINERARY landed accounts -- shelved `20260908.174012`
...
the way a closed REDS row folds. This shelf carries the COPAL block as it stood before `20260908.174012` --
the lap that read the write's target rather than its whole matched span.

## COPAL

**COPAL -- A SOURCE WAS ANSWERING FOR A TARGET, IN BOTH DIRECTIONS AT ONCE.**
Elder [shelved](20260908-161206_itinerary-landed-accounts.md). Row `20260908.161206`
