# ITINERARY landed accounts -- shelved `20260908.072606`
...
## COPAL -- a guard read a room, and the roster runs files outside it (`20260908.052557`)

**COPAL -- A GUARD READ A ROOM, AND THE ROSTER RUNS FILES OUTSIDE IT.**
Elder [shelved](20260908-052557_itinerary-landed-accounts.md); row (`20260908.052557`)
**CLOSED**, [folded](../../REDS/REDS-a-population-picked-by-directory-rows-618.md). `shared_pen_scan.sh` picked its population with `git ls-files 'tools/*'` -- yet its WHY
