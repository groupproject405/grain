# ITINERARY landed accounts -- folded `20260907.111058`

**Language:** EN
**Style:** Gauge, Meter setting
**Voice:** Kyri
**Status:** Shelf -- immutable once written. Folded from `construction/ITINERARY.md` to hold the
pin under `living_pin_max_bytes` (40,960). Every claim is carried word for word; the account's
still-open questions stayed on the pin rather than coming here.

**DIFFUSER -- TWO READERS AGREED A PAPER WAS SUPERSEDED, ON EVIDENCE THAT READS THE SAME FROM EITHER END.**
Row `20260907.095458` **CLOSED**, [folded](../../REDS/REDS-a-supersede-reads-backwards-rows-559.md); elder [shelved](20260907-095458_itinerary-landed-accounts.md).
...
**Still yours** (whole on its [shelf](20260907-095458_itinerary-landed-accounts.md)): the
