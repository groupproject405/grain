...
**Folded:** `20260907.095650` -- **Status:** Archived, complete, never edited
**Living card:** [`../ITINERARY.md`](../../../ITINERARY.md)

*The accounts below stood on the operator card's live front until their work landed. The card holds
...
`%536` BOOKED, [folded](../../REDS/REDS-a-number-is-a-view-and-the-stamp-is-the-key-rows-536.md);
account [folded](20260907-084022_itinerary-landed-accounts.md). `reds_ledger_monotone` asked
