# ITINERARY landed accounts -- folded `20260907.170116`

**Folded:** `20260907.170116` -- **Status:** Archived, complete, never edited
**Voice:** Kyri -- **Room:** checkable
**Why:** the living card sits close to its ceiling, so the elder PHEROMONE account folds here and
the card carries only what this round opened and what is still open.
...
**PHEROMONE -- THE ASCII LAW HELD TWO COMMENT MARKS, AND A THIRD LANGUAGE OF OUR OWN SAT OUTSIDE IT.**
Row `20260907.144002` **BOOKED**, [folded](../../REDS/REDS-the-third-comment-mark-rows-575.md).
...
[folded](20260907-144002_itinerary-landed-accounts.md). **Yours:** a mistyped link here reds
eight ships.
