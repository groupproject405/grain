...
**Folded:** `20260907.210804` -- **Status:** Archived, complete, never edited
**Living card:** [`../ITINERARY.md`](../../../ITINERARY.md)

*The Patchouli account of the lap that was parked three times and landed whole, folded off the
live front so the card could hold the boundary the next lap pressed. The full record is the
session log
[`20260907-195724_the-lap-that-was-already-written.kyri`](../../../../session-logs/date/20260907/20260907-195724_the-lap-that-was-already-written.kyri).*

---

**PATCHOULI -- A PROVEN LAP PARKED THREE TIMES, RECOVERED THREE TIMES, AND LANDED WHOLE.**
Elder and this lap's recovery both [shelved](20260907-191757_itinerary-landed-accounts.md)
