# ITINERARY landed accounts -- `20260907.050220`

**Language:** EN
**Stamp:** `20260907.050220`
**Status:** Shelf -- immutable once written
**Voice:** Kyri
**Folded from:** [`../ITINERARY.md`](../../../ITINERARY.md), the Petrichor account, when the card stood
**6 bytes above** its 40,960 bound and `equinox_e123_living_pin_guard` was refusing on it for
every ship on the pier.

**The account below is landed.** Its row was booked `20260907.015907`, renumbered off a number the
anointed spine had already spent, and folded to
[`REDS-the-word-a-gloss-could-not-bind-rows-551.md`](../../REDS/REDS-the-word-a-gloss-could-not-bind-rows-551.md)
in the lap this shelf makes room for.

**One question carries forward onto the card** and stays Keaton's: whether a lap may assign a room
token to a page it did not write. The measurement behind it grew this lap -- the doorway guard
reads three rooms, `foundations/` is none of them, and 65 of that room's 83 pages name no room,
including 18 of the 20 pages the council rota puts in front of every ship every day.

Every word below is the card's own, unedited, its links re-anchored one directory deeper for the
shelf it now stands on.
...
[shelved](20260907-022951_itinerary-landed-accounts.md). Row (`20260907.015907`) BOOKED, by
