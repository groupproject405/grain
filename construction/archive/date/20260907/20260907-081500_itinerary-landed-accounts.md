# Landed accounts -- `20260907.081500`, Bakery
...
The live front stood 1,629 bytes above its 40,960 bound the moment the new account landed, and this
was the block the new one replaces -- a lap's own elder account, closed by its own author. No peer's
block was moved to make the room.
...
## What it left standing, and where that went

Its own open question -- *whether another rostered guard is clock-shaped* -- stays unmeasured and is
carried forward on the live front. Its three-guard flake family (`fleet_watch`,
`standing_equipment`, `amphora_carry_negative`) is COPAL's row, one lane over, and Copal's own
account of `20260907.062408` names the mechanism it found: seven constant pens in one lane, proven
both ways on metal.

*The sentence worth carrying forward from the box: **the oldest proven work in a tree is the work
that has passed its controls and has not yet been sent**, so landing it outranks building beside it.
That reading is what emptied the box, and this shelf is where the box's record rests.*
