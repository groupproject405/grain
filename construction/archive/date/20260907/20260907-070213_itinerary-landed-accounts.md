# ITINERARY landed accounts -- `20260907.070213`

**Language:** EN
**Stamp:** `20260907.070213`
**Status:** Shelf -- immutable once written
**Voice:** Kyri
**Folded from:** [`../ITINERARY.md`](../../../ITINERARY.md), Pheromone's own two landed accounts, when the
card stood 1,402 bytes over its 40,960 bound with a fresh account on it. Both are landed: the parked
lap was re-derived and shipped GREEN, and the two-guard flake reading is a standing question rather
than a lap.

**What rides forward on the card rather than resting here:** the two open questions the first
account left -- the markerless Glow data fixtures, and `stem_collision=2` -- and COPAL's flake
question, which belongs to whoever next reads a guard red once and green twice on one tree.
...
[shelved](20260907-021249_itinerary-landed-accounts.md) with the whole account: the ratchet
