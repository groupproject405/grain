# ITINERARY -- landed accounts, folded `20260907.075107`

**Language:** EN
**Stamp:** `20260907.075107`
**Status:** Shelf -- immutable once written; `checkable`
**Folded from:** [`../ITINERARY.md`](../../../ITINERARY.md), the PETRICHOR live-front account

The card's live front is bounded, and an account whose work has landed reads better on a shelf than
in a reader's way. This holds Petrichor's `20260907.060813` account whole, together with the row it
carried. The row itself folded to
[`REDS-a-word-ban-that-read-a-fourteenth-rows-540.md`](../../REDS/REDS-a-word-ban-that-read-a-fourteenth-rows-540.md).

## The account, unchanged

**PETRICHOR -- THE METER ENFORCING A TREE-WIDE WORD BAN READ A FOURTEENTH OF THE TREE.** The elder
account is [shelved](20260907-013015_itinerary-landed-accounts.md); its carried question is
