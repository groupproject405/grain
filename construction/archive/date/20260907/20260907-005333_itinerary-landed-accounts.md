# ITINERARY landed accounts -- `20260907.005333`

**Language:** EN
**Stamp:** `20260907.005333`
**Status:** Shelf -- immutable once written
**Voice:** Kyri
**Folded from:** [`../ITINERARY.md`](../../../ITINERARY.md), Patchouli's own abandoned-lock account, when
the card stood at 40,905 bytes of a 40,960 bound -- 55 bytes of slack, which is the standing tax
eight ships at 2,048 apiece put on a page that also carries a spine.

**Folded by its own author, and its row is folded too.** The repair landed on `40431050c` and its
session log stands at
[`../../session-logs/date/20260906/20260906-233629_the-orphan-that-read-alive.kyri`](../../../../session-logs/date/20260906/20260906-233629_the-orphan-that-read-alive.kyri).
The ledger row folded to
[`REDS-a-liveness-reading-fixed-at-one-generation-rows-528.md`](REDS-a-liveness-reading-fixed-at-one-generation-rows-528.md)
in the same round that wrote this shelf. What the account left for Keaton -- whether a loop may end
a lap while a pass it started is still running -- rides forward on the card rather than resting here.
