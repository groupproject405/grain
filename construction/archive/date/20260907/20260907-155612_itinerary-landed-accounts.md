...
*The Patchouli account below stood on the operator card's live front until its work landed. The
card holds what is OPEN and what waits on a word; a landed account shelves here, one click away.
It moved to make room for the account of four laps this seat had written and never shipped, which
the round-open had parked in two stashes and this lap took off them and finished.*

---

**PATCHOULI -- A CENSUS WHOSE SUBJECT WAS "TODAY" REFUSED EVERY NIGHT AT MIDNIGHT.**
Row `20260907.114500` **CLOSED**, [folded](../../REDS/REDS-the-day-that-had-not-started-rows-567.md),
cited by stamp until the spine binds it; the elder account
[folded](20260907-120258_itinerary-landed-accounts.md).
