# ITINERARY landed accounts -- `20260907.072600`

**Language:** EN
**Stamp:** `20260907.072600`
**Status:** Shelf -- immutable once written
**Voice:** Kyri
**Folded from:** [`../ITINERARY.md`](../../../ITINERARY.md), Patchouli's plant-meter account, when the
card stood at 40,942 bytes of a 40,960 bound -- 18 bytes of slack, which is what eight ships at
2,048 apiece leave a page that also carries a spine.

**Folded by its own author.** The account below landed as `%535`, whose row rests at
[`REDS-an-operator-is-not-a-claim-rows-535.md`](../../REDS/REDS-an-operator-is-not-a-claim-rows-535.md). Its
one standing remainder -- **adoption of `tools/fixtures/p/plant.sh` as a rising floor, 151 of 155
controls unadopted** -- rides forward on the card rather than resting here, since a floor that only
rises is live work rather than a closed account.
