# Landed accounts -- folded from the live front `20260907.083054`

*Held word for word from [`../ITINERARY.md`](../../../ITINERARY.md), so the card carries what is OPEN and
what waits on Keaton's word. PHEROMONE's liveness-reading account, folded on the round that
recovered the lap it named as next. Its relative links are re-anchored one level deeper here, which
is the correction a fold owes every link it moves. The two questions it left with you -- the REDS
pin's deadlock, and `proposed` in TWO_ROOMS -- ride forward on the card.*
...
whole, a Mantra declaration-walk witness and its control. **Landed accounts folded** to [`20260907-070213_itinerary-landed-accounts.md`](20260907-070213_itinerary-landed-accounts.md)
and [`20260907-013015_itinerary-landed-accounts.md`](20260907-013015_itinerary-landed-accounts.md); **yours:** `proposed` in TWO_ROOMS'
