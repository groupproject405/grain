# Landed accounts -- folded from the live front `20260907.010121`

*Held word for word from [`../ITINERARY.md`](../../../ITINERARY.md), so the card carries what is OPEN and
what waits on Keaton's word. PHEROMONE's closed ratchet account, folded to make room for the desk
corpus's own reach. Its relative links are re-anchored one level deeper here, which is the
...
**Two Pheromone accounts folded** to the [`002052` shelf](20260907-002052_itinerary-landed-accounts.md); rostering `glow_run_desk_witness.rish` is yours.
