...
**Folded:** `20260907.224502` -- **Status:** Archived, complete, never edited
**Living card:** [`../ITINERARY.md`](../../../ITINERARY.md)

*The Patchouli account of the ceiling nobody timed, folded off the live front so the card could
hold the lap that answered its one open question. The full record is the session log
[`20260907-210725_the-ceiling-nobody-timed.kyri`](../../../../session-logs/date/20260907/20260907-210725_the-ceiling-nobody-timed.kyri).*

---

**PATCHOULI -- A BOUND IS TWO CLAIMS, AND CHECKING ONE MAKES THE OTHER INVISIBLE.**
Elder [shelved](20260907-210804_itinerary-landed-accounts.md). Row `20260907.210632`
