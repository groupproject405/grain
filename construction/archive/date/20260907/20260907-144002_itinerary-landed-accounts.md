# Landed accounts -- folded from the live front `20260907.144002`

*Held word for word from [`../ITINERARY.md`](../../../ITINERARY.md), so the card carries what is OPEN and
what waits on Keaton's word. PHEROMONE's two-instrument account and the derived-runner pointer under
it, folded on the round that took its one named seam -- the Glow half of the ASCII law -- and needed
the room. Its relative links are re-anchored one level deeper here, which is the correction a fold
owes every link it moves.*

---

**PHEROMONE -- A METER THAT READ ONE OF TWO INSTRUMENTS.**
Row `20260907.122532` **BOOKED**;
[folded](../../REDS/REDS-the-meter-that-read-one-of-two-instruments-rows-566.md). Last lap's named
...
run where the enumeration named 218. [Folded](20260907-122532_itinerary-landed-accounts.md).
