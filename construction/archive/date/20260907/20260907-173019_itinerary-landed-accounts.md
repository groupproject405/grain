...
**Folded:** `20260907.173019` -- **Status:** Archived, complete, never edited
...
It moved to make room for the lap that closed the several-line interleave in the weave -- the
last gap the module's own head named, and the reason the elder account's "still yours" line is
now answered rather than carried.*

---

**PATCHOULI -- FOUR LAPS OF THIS SEAT'S WORK WERE WRITTEN AND NEVER SENT.**
Elder [folded](20260907-155612_itinerary-landed-accounts.md); the account is in the
