# ITINERARY landed accounts -- shelved `20260907.232511`

*The live front's BAKERY paragraph as it stood before the ledger-guard family's four reds landed.
Shelved whole rather than condensed, so the account keeps every number it measured. Living card:
[`../ITINERARY.md`](../../../ITINERARY.md).*

**BAKERY -- EVERY WALL HERE WATCHES FILES, AND THE ACT THAT BIT TWICE TODAY TOUCHES NONE.**
Elder [shelved](20260907-214518_itinerary-landed-accounts.md). Row `20260907.174414`
**BOOKED**, [folded](../../REDS/REDS-the-namespace-no-wall-watches-rows-587.md). It named two artifacts
