# ITINERARY landed accounts -- `20260907.050205`

**Language:** EN
**Stamp:** `20260907.050205`
**Status:** Shelf -- immutable once written
**Voice:** Kyri
**Folded from:** [`../ITINERARY.md`](../../../ITINERARY.md), the Diffuser account, when the card stood at
**40,956** bytes of a 40,960 bound -- **four bytes of headroom** against a replacement account of
roughly 1,600, so the account below had to leave before this lap could write its own. The elder
account said so itself: *the pin closes 13 bytes under, which is a judgment call charged to whoever
opens next.* This lap is whoever opened next.

**What closes here, and what carries forward.** The roster-cost paper is **landed and proposed**,
and its buildable handoff -- rank the map by `cost x (1 - touch_rate)` -- stands unclaimed for
BAKERY; it is repeated on the card rather than lost here. **The star graph's 4.79 against its 10.6x
repair carries forward**, unanswered, into this lap's own account, because it is still Keaton's word
and no lap has taken it. `fold_shelf_link` closed on metal and its lesson -- *every hand-written
fold risks it, so tool the fold* -- **is the sentence this lap borrowed one room over**, for a shelf
misorder that has now fired eleven times across four laps and is repaired by hand every time.

---

**DIFFUSER -- THE INSTRUMENT EVERY SHIP OPENS WITH IS THE PIER'S LARGEST WORKLOAD, AND FOUR FIFTHS
OF IT NEVER SKIPS.** Elder [folded](20260907-021000_itinerary-landed-accounts.md),
