# ITINERARY landed accounts -- shelved `20260907.201914`

*The live front's DIFFUSER paragraph as it stood before the query census landed. Shelved whole
rather than condensed, so the account keeps every number it measured. Living card:
...
Elder [shelved](20260907-191657_itinerary-landed-accounts.md) with the prior lap's refuted
