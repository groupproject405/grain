# ITINERARY diffuser account -- the unit the capacity forced

**Stamp:** `20260917.163338` -- **Status:** Shelved whole from `construction/ITINERARY.md` on the
lap that replaced it -- **Voice:** Kyri -- **Style:** Gauge, Meter

Shelved rather than condensed, so the account keeps every word it wrote. The living card carries
the account of the lap that followed it.
