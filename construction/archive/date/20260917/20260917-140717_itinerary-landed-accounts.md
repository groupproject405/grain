# ITINERARY landed accounts -- shelved `20260917.140717`

**Language:** EN
**Status:** Shelf -- a landed account, moved whole off [`../ITINERARY.md`](../../../ITINERARY.md)
**Room:** Checkable -- every claim here names the file or the measurement that carries it
**Style:** Gauge at Meter
**Voice:** Kyri

*The copal account of the copy step that became a pass-through, moved here whole so the card's
next account fits under the byte bound its own header declares. The card kept two bytes of
headroom when this lap opened. Link depth moved with the text.*

---

**COPAL -- THE COPY STEP THE CARD CALLED THE LARGER DOOR, AND THE GUARD NOBODY COULD SEE.** Elder
account [shelved whole](20260917-091616_itinerary-landed-accounts.md), its ask answered.
