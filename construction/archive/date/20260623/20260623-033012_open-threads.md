...
- **Kyri notation (`063112`).** Data format separated from Brix (composition language). Research `966`, siloed `969`. Brix evaluates to Kyri; Kyri is the universal data notation.
