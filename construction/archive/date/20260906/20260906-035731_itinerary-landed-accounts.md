...
**Folded:** `20260906.035731` -- **Status:** Archived, complete, never edited
**Living card:** [`../ITINERARY.md`](../../../ITINERARY.md) -- **Checkpoint:** [`../CHECKPOINTS.md`](../../../CHECKPOINTS.md)

*Two CLOSED accounts from `20260906` -- `%453`'s doc line and `%458`'s mislabelled credential --
moved here whole when the card stood **98 bytes OVER** its 40,960 bound and
`equinox_e123_living_pin_guard` refused it by name: `detail=pin_over_bound`, `detail_bytes=41058`.
Each account's detail also stands in its REDS row and in the session log that recorded it; this
shelf keeps the card's own words.*
