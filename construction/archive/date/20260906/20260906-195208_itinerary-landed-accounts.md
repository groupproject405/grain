# ITINERARY landed accounts -- folded `20260906.195208`

**Language:** EN - **Status:** Shelf, immutable - **Folded from** [`../ITINERARY.md`](../../../ITINERARY.md), which stood 420 bytes from its 40,960 ceiling with a live account to write. The row below reads CLOSED and points at its own REDS shelf; the card keeps the pointer and this page keeps the arithmetic. Walk-back nib `5826c9be29`, cairn in [`../CHECKPOINTS.md`](../../../CHECKPOINTS.md).
