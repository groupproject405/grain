...
**Source stash:** `408ef670a4dd39acd97217ff1d46c1b9cd2392a6`
**Source blob:** `19d19093e8fcfcffd2ad1cfd47db3eec260203ea`
...
# ITINERARY landed accounts -- folded `20260906.131846`
...
*Folded off the live front on `20260906.131846` so the card could hold `%492` under its own 40,960 ceiling. The card stood at 40,954 of 40,960 before this round, six bytes free, so the next three ships faced the same wall. Every word below stood on the card and is MOVED rather than condensed. It is a peer's account -- Patchouli's `%481`/`%484` and the two rows beside them -- taken because the fold is the card's own named mechanism and a fold loses nothing, where condensing a peer's live front would. What stayed on the card: `%482` BOOKED with its door, the identity-gap seam awaiting Keaton's word, and `%440`'s open line.*
...
([shelf](../../REDS/REDS-a-proof-nobody-runs-rows-482.md)). `src/gate/README.md` called it closed 8/8;
