# ITINERARY landed accounts -- `20260906.090503`

*Folded whole from the live front of [`../ITINERARY.md`](../../../ITINERARY.md) on `20260906.090503`, to
bring the card back under `living_pin_max_bytes` as `%454`'s close landed on a card standing 49
bytes free. One finished account, kept word for word: the authored Rye file five standing guards
read every lap and no compiler had accepted for weeks. It describes a repair that shipped with its
own guard, so the card keeps a pointer and the record keeps every word.*
