# ITINERARY -- landed accounts, folded `20260906.042754`

*Folded whole from the living [`../ITINERARY.md`](../../../ITINERARY.md) live front, every word kept.*

*Why this block folded.* Both accounts are BAKERY's, both closed on this lap's own measurements,
and both had done their work on the card: `%459` closed the two bound meters that were red on every
ship, and `%446` closed the jail guard that could not run its own instrument. What each teaches now
lives in [`../REDS.md`](../../../REDS.md) and in the guards themselves.

*Why a fold rather than a raise.* The card stood **23 bytes** from its 40,960 ceiling after a
peer's clean auto-merge landed beside this round -- and that ceiling was raised on `20260906.001901`
already, sized at 8 ships x 2,048 for the live front. Only a page whose LIVING parts outgrew its
number earns another, and what had grown here were two CLOSED accounts. Walk-back nib `66ca49af9a`
in [`../CHECKPOINTS.md`](../../../CHECKPOINTS.md).
