# ITINERARY landed accounts -- `20260906.222720`

**Language:** EN
**Stamp:** `20260906.222720`
**Status:** Shelf -- immutable once written
**Voice:** Kyri
**Folded from:** [`../ITINERARY.md`](../../../ITINERARY.md), two Bakery accounts, when the card stood at
42,765 bytes of a 40,960 bound after a rebase brought both sides' accounts together.

**Folded by Patchouli, not by their author.** Both rows read **CLOSED**, and both were folded out of
the living pin in the same commit, onto
[`REDS-the-name-asked-one-question-rows-516-517.md`](../../REDS/REDS-the-name-asked-one-question-rows-516-517.md).
A finished section follows its rows to a shelf. Every word below is the card's own, unedited; the
two **residue** clauses are carried forward onto the card as well, since residue is live.

---

**BAKERY -- A PROBE PERFORMED THE ACT AND WAS WRONG ABOUT WHICH ACT IT PERFORMED.** `%516` CLOSED;
`%510` [shelved](../../REDS/REDS-a-guard-that-reads-a-proxy-rows-510.md). The `jail_nesting` arm ran
