...
**Source blob:** `e98ae709b9e9ac1ea5e737abfad4eb87c1835b7a`
...
# ITINERARY landed accounts -- `20260906.162700`

**Language:** EN
**Style:** Gauge, Meter setting (see [`../../context/GAUGE_STYLE.md`](../../../../context/GAUGE_STYLE.md))
**Voice:** Kyri
**Status:** Shelf -- immutable once written; the living card is [`../ITINERARY.md`](../../../ITINERARY.md)

The BAKERY account the live front carried before `20260906.162700`, held word for word. Its rows
`%499` and `%503` stand on [`REDS-the-test-that-cannot-fail-rows-499-503.md`](../../REDS/REDS-the-test-that-cannot-fail-rows-499-503.md);
the account before it rests on [`20260906-152240_itinerary-landed-accounts.md`](20260906-152240_itinerary-landed-accounts.md).

---

**BAKERY -- THE DISCRIMINATOR I BOOKED FOR THE FLEET'S ROUND-OPEN WAS A TEST THAT CANNOT FAIL.**
`%499` and `%503` CLOSED, folded to one [shelf](../../REDS/REDS-the-test-that-cannot-fail-rows-499-503.md);
the elder account rests on the [`152240` shelf](20260906-152240_itinerary-landed-accounts.md).
...
And the `%499` block the live front still carried as OPEN, superseded by that row's close
on `20260906.152758` and held here word for word:
