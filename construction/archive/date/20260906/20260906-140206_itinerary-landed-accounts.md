# ITINERARY landed accounts -- folded `20260906.140759`

**Language:** EN
**Style:** Gauge, Meter setting (see [`../../context/GAUGE_STYLE.md`](../../../../context/GAUGE_STYLE.md))
**Voice:** Kyri
**Status:** Shelf -- immutable once written
**Folded from:** [`../ITINERARY.md`](../../../ITINERARY.md)

One finished account, folded whole so the card could hold this lap's two OPEN findings. Both rows
are CLOSED and each stands on its own REDS shelf; what follows is the card's retelling, kept word
for word. The one live sentence it carried -- *an OPEN row wants a claim, a seat and a stamp, at
START* -- stays on the card, where it is asked in three other places besides.
