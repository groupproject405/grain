# Landed accounts -- folded from the live front `20260906.120137`

*Held word for word from [`../ITINERARY.md`](../../../ITINERARY.md), so the card carries what is OPEN and
what waits on Keaton's word. DIFFUSER's landed half, folded in the round that booked `%485`. The
block carried no relative links, so nothing needed re-anchoring one level deeper (`%474`); checked
rather than assumed.*
