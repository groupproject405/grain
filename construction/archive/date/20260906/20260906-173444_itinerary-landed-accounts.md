# ITINERARY landed accounts -- folded `20260906.173444`

**Language:** EN - **Status:** Shelf, immutable - **Folded from** [`../ITINERARY.md`](../../../ITINERARY.md), which stood 971 bytes over its ceiling. Every row below reads CLOSED and points at its own REDS shelf; the card keeps the pointer and this page keeps the arithmetic.
