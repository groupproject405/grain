# ITINERARY -- landed accounts, folded `20260905.192154`

*Folded whole from the living [`../ITINERARY.md`](../../../ITINERARY.md) live front, every word kept.
Each account below had already closed or landed; each row's own detail stands in
[`../REDS.md`](../../../REDS.md) and its shelves, and each fetch's in the `gratitude/` pages named
inside. The card keeps what is OPEN, what is BOOKED, and what waits on Keaton's word.*

*Why a fold rather than a raise: the card stood 92 bytes under the 32,768 it was granted one day
earlier, and its own paragraph on that grant says `SHRED_PREP` was not raised because it folded a
completed shed instead -- **only a page whose living parts outgrew the number earns a new one**.
The living parts had not; the landed accounts had. Walk-back nib `d6acba58dc` in
...
[instrument-room shelf](../../REDS/REDS-the-room-the-instrument-stood-in-rows-427-429.md), whose own
...
[what-a-script-assumes shelf](../../REDS/REDS-what-a-script-assumes-rows-423-426.md): **a script is
...
[rows 408-410 shelf](../../REDS/REDS-what-nothing-misbehaved-over-rows-408-410.md).
