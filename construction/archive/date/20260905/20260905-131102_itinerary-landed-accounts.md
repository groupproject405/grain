# ITINERARY -- landed accounts, folded `20260905.131102`

*Folded whole from the living [`../ITINERARY.md`](../../../ITINERARY.md) live front. Every account below
had already closed; each row's own detail stands in [`../REDS.md`](../../../REDS.md) and its shelves, and
each fetch's in the `gratitude/` pages named inside. The card keeps what is OPEN, what is NEXT, and
what waits on Keaton's word. Walk-back and reasoning: [`../CHECKPOINTS.md`](../../../CHECKPOINTS.md).*
...
**Shelved:** eleven rows -- [`the recital`](../../REDS/REDS-fold-recital.md).
**`%414`-`%416` CLOSED**, whole on the
[wrapper-and-sandbox shelf](../../REDS/REDS-what-a-wrapper-and-a-sandbox-inherit-rows-414-416.md):
...
[a-claim-goes-stale shelf](../../REDS/REDS-a-claim-goes-stale-rows-419-422.md) -- a credential newer by
...
**`%417`/`%418` CLOSED**, on the [what-a-copy-carries shelf](../../REDS/REDS-what-a-copy-carries-rows-417-418.md):
