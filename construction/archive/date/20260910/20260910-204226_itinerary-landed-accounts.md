# ITINERARY landed accounts -- shelved `20260910.204226`

**Language:** EN
**Style:** Gauge, Meter setting (see [`../../context/GAUGE_STYLE.md`](../../../../context/GAUGE_STYLE.md))
**Voice:** Kyri
**Status:** Testimony -- the PETRICHOR live-front block as it left `construction/ITINERARY.md`, with its one ask printed as it went

**PETRICHOR -- TWO READERS OF ONE LINE, AND ONE OF THEM ANNOUNCED THEY AGREED.**
Elder [shelved](20260910-175434_itinerary-landed-accounts.md); the pin sat 3 bytes under
