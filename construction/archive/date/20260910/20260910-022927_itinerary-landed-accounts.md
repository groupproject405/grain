# ITINERARY landed accounts -- shelved `20260910.022927`

**Language:** EN
**Status:** Shelf -- testimony, immutable once written
**Voice:** Kyri

The COPAL account the live front carried until `20260910.022927`, shelved whole so the card holds
what is OPEN and what waits on a word.

**COPAL -- A READING DID NOT CHANGE; THE WORLD IT READS DID.**
Elder [shelved](20260910-003047_itinerary-landed-accounts.md) whole.
...
[shelf](../../REDS/REDS-the-loom-that-chased-a-generation-too-far-rows-681.md).
