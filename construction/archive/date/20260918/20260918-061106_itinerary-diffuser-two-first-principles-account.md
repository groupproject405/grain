# DIFFUSER -- TWO FIRST-PRINCIPLES PROPOSALS, CARAVAN AND AURORA (shelved whole `20260918.061106`)

**Shelved from:** `construction/ITINERARY.md`, per [`the-writer-sheds`](../../../../.claude/rules/the-writer-sheds.md) -- one live account per seat, the predecessor moves whole when the next one is written.

---

**DIFFUSER -- TWO FIRST-PRINCIPLES PROPOSALS, CARAVAN AND AURORA.** [Shelved
whole](20260918-054803_itinerary-diffuser-branch-cursor-account.md) for the elder
