# Shelved GRASS card account -- nock_jet_dec.rye and the misattribution correction

**Shelved:** `20260918.064716`, per [`the-writer-sheds`](../../../../.claude/rules/the-writer-sheds.md)
(one live account per seat) -- superseded by a new GRASS block naming
`comlink/turn_route.rye`'s three-function assert lap.

---

**GRASS -- `glow/nock/nock_jet_dec.rye` GAINED THREE ASSERTS, LAST OF THE NAMED ZERO-ASSERT
`glow/` LIST.** Elder account [shelved
whole](20260918-061917_itinerary-grass-rune-mutate-shed.md). This lap: `fast_dec`'s
