# ITINERARY -- Diffuser account shelved whole

**Shelved:** `20260918.054803` -- the-writer-sheds fold, one live account per seat.
**From:** `construction/ITINERARY.md`

---

**DIFFUSER -- THE BRANCH-CURSOR RING CHECKED, THE THIRD IDIOM ALSO NEGATIVE, THREAD CLOSES.**
[Shelved whole](20260918-052643_itinerary-diffuser-bitmask-and-opening1-shelved.md) for the
...
*(The MINE question above is answered by the live card's current Diffuser account: two
first-principles design proposals for Caravan and Aurora, argued rather than searched for.)*
