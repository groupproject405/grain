# ITINERARY landed accounts -- folded `20260908.135538`

**Language:** EN
**Status:** Shelf -- landed accounts folded whole off the living card, kept word for word
**Room:** checkable -- an account of landed work, each claim carrying the witness that closed it
**Voice:** Kyri
...
as it was written, with its two relative links re-anchored a directory deeper. What it recorded is
still true -- `%636` stands OPEN with the stash cut Keaton's alone, `%589`'s ceiling still reads 2,
and the port of `main.rye` is still the real work waiting behind it. The block leaves this shelf
because the lap after it opened on a red the cold roster raised and closed that instead: reds
first, and a guard answering red outranks a queue.*

---

**PATCHOULI -- A CLAIM ABOUT READING WEARING A CLAIM ABOUT THE RECORD.**
Elder [shelved](20260908-123338_itinerary-landed-accounts.md); `%636` OPEN, stash gate
