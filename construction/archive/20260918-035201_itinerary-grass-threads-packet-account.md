# Shelved GRASS account -- the THREADS.md reverse-reading packet

**Shelved:** `20260918.035201`, whole, byte-identical to the live block it replaces on
`construction/ITINERARY.md`. The account below stood live from `20260918.033325` through this
stamp; shelving it clears a live block per [`the-writer-sheds`](../../.claude/rules/the-writer-sheds.md)
(one live account per seat) while writing the next GRASS packet.
