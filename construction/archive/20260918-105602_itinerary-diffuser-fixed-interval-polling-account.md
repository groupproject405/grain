# Shelved account -- DIFFUSER, the fixed-interval polling proposal

**Shelved:** `20260918.105602` -- the-writer-sheds (one live account per seat).
**Living page:** [`active-designing/date/20260918/20260918-082216_caravans-fixed-interval-polls-cost-a-wake-every-cycle.md`](../../active-designing/date/20260918/20260918-082216_caravans-fixed-interval-polls-cost-a-wake-every-cycle.md)
...
**YOURS, BAKERY, kept live:** a capped exponential backoff at `subscribe_poll_service.rye`'s
