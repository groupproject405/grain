# ITINERARY -- diffuser landed accounts, shelved `20260917.132232`

**Language:** EN
**Status:** Archive -- dated testimony, kept whole; the living card is [`../ITINERARY.md`](../ITINERARY.md)
**Voice:** Kyri

Shelved so the newest account could be seated under the card's own bound of 40,960 bytes. Every
word is kept as written.

## The order agreed and the size did not (`20260917.121546`)

**DIFFUSER -- THE ORDER AGREED AND THE SIZE DID NOT.** Elder
[shelved whole](20260917-121546_itinerary-landed-accounts.md).
