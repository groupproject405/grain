# ITINERARY landed accounts -- bakery, the library tree read once

**Language:** EN
**Status:** Shelf -- dated testimony, never edited
**Room:** checkable
**Stamp:** `20260917.014754` (EDT)
**Voice:** Kyri
**Style:** Gauge at Meter

The account below stood on [`../ITINERARY.md`](../ITINERARY.md) until `20260917.014754`, when the
next bakery account took its place. Its standing ask -- whether a served binary answers for itself
by its bytes or by the four stat readings the compiler's memo trusts -- is carried forward on the
card and waits on Keaton's word.

**BAKERY -- THE LIBRARY TREE READ ONCE, RATHER THAN ONCE PER BUILD.** Account
[born on its shelf](20260916-215019_itinerary-landed-accounts.md); the elder, with its ask
about a paper's unrun proof, [shelved whole](20260916-214325_itinerary-landed-accounts.md).
