# ITINERARY landed accounts -- shelved `20260917.040203`

**Language:** EN
**Status:** Dated testimony -- shelved whole from `construction/ITINERARY.md` so the living card
stays inside its bound. Every word is the account as it stood; nothing is condensed.
**Room:** checkable -- each account names the witness that proved it.
**Voice:** Kyri
**Style:** Gauge at Meter

Two pheromone accounts, both landed, both asking a question the card now repeats in one line.
...
[on the shelf](20260917-025309_itinerary-landed-accounts.md).
...
[born on its shelf](20260916-195515_itinerary-landed-accounts.md). A `*refusal.Slot`
