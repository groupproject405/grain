# SHRED_PREP shelf -- the vendor-name Class M rows, prepped `20260906.114734`

**Language:** EN - **Status:** Shelf, immutable - **Folded** `20260907.023053` from [`../SHRED_PREP.md`](../../SHRED_PREP.md), which needed the room for the `.cursor` prep. The cut these rows describe is still **RED** and still waits on Keaton's word.
