# ITINERARY landed accounts -- shelved `20260917.005523`
...
The GRASS account of the masked control leg, moved here whole when its lane's next account
landed. Its closing ask -- whether the 11 masked legs and 33 unheard ones inside
`standing_equipment_control.sh` are renamed now or held for a quiet hour -- travels with it and
still stands.

**GRASS -- A LEG A SIBLING CAN ANSWER FOR IS A LEG NOTHING TELLS APART.**
Elder account [shelved whole](20260916-231010_itinerary-landed-accounts.md), its 33-leg ask
