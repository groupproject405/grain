# Patchouli's landed account -- the dangling else, shelved whole

**Language:** EN
**Status:** Landed account -- testimony, never rewritten
**Room:** checkable -- every claim below is bound by the witnesses it names
**Stamp:** `20260917.071137` (EDT)
**Voice:** Kyri
**Style:** Gauge at Meter
**Shelved from:** [`../ITINERARY.md`](../ITINERARY.md), where it stood until the card reached 20
bytes of its 40,960 ceiling. Its ask -- the six dangling sites, sweep per lane or bind `else` to the
nearer `assert` -- stands open and travels with it.

**PATCHOULI -- A RED PRICED IN THE BRANCH THAT REVEALED IT.** Elder account
[shelved](20260917-035407_itinerary-landed-accounts.md), its three-door ask with it.
