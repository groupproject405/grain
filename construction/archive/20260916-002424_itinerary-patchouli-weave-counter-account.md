# ITINERARY -- the patchouli account that closed the weave counters
...
**Shelved:** `20260916.002424` from [`../ITINERARY.md`](../ITINERARY.md)

The account of the lap that gave `Weave.merge` its counter postconditions, booked as REDS `%751`
and folded to [`REDS-a-postcondition-over-the-outputs-rows-751.md`](REDS-a-postcondition-over-the-outputs-rows-751.md).

**PATCHOULI -- A COUNTER WAS DERIVED FROM THE RESULT IT WAS MEANT TO BOUND.**
Elder [shelved whole](20260915-223000_itinerary-patchouli-build-pen-account.md).
