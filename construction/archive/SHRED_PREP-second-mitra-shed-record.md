# The second mitra shed -- the record of what was cut

*Folded from the living pin [`../SHRED_PREP.md`](../SHRED_PREP.md) on `20260904.193221`. The shed itself
closed `20260827.162143`: ten fossils cut, every mutant standing, every living citer repointed
first. A completed shed's record is finished-and-historical, which is `ORGANIZING.md`'s own
definition of archive, and it was the largest block on a pin that had **210 bytes of headroom**.
The rows stand exactly as they were written; the word stays **shred RED** until the next circle.
