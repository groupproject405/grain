...
`tools/gen/chapter/` witnesses still pass, and what does a sing cost -- before a roster row is
proposed.
---
## Landed arcs
...
1,024-round itinerary, **TACT** Journeys 1, 2 and 4, the recursion-prompts cellar, Chapter A's open
