...
<<<<<<< HEAD
**Git nib:** `733853f536` -- this commit's parent, resolvable everywhere (%401).
=======
**Git nib:** `980579ee8b` -- this commit's parent, resolvable everywhere (%401).
>>>>>>> 8b5a24c00 (Keep a fresh stage store quiet until a write fills it.)
