...
|------|------------|------------|
| **Language** -- what you can type and witness | [`../tutorials/first-witness.md`](../tutorials/first-witness.md) (Rishi) | Glow: [`../../glow/README.md`](../../glow/README.md) (eight heads) - Acme first code `../../expanding-prompts/yonder/20260717-213242_glow-first-code-beside-glass-and-open-runes.md` |
...
1. **Walk the compass once** -- compressor [`../../docs/COMPASS.md`](../../docs/COMPASS.md) - card [`../../docs/compass_card.kyri`](../../docs/compass_card.kyri) - tutorial `../../.cursor-archive/manual-tutorials/cursor-and-the-compass.md`. Stitches foundations, **witness habitat** (Acme face for the happy zone), Cursor rules, Kyri logging, and send.
