...
1. **Walk the compass once** -- compressor [`../../docs/COMPASS.md`](../../docs/COMPASS.md) - card [`../../docs/compass_card.bron`](../../docs/compass_card.bron) - tutorial [`../../.cursor-archive/manual-tutorials/cursor-and-the-compass.md`](../../.cursor-archive/manual-tutorials/cursor-and-the-compass.md). Stitches foundations, **witness habitat** (Acme face for the happy zone), Cursor rules, Bron logging, and send.
