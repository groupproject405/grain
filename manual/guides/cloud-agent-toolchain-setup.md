...
This is the same recipe an earlier Cursor for iOS round used against a persistent ai-jail host (`construction/archive/date/20260703/20260703-021412_counsel-and-confirmation-tests.md`, Step 1) -- pip's `ziglang` package stands in for the checksum-verified official-release fetch `rye/README.md` names for a persistent host. Confirmed fresh on a Cursor Cloud Agent's own Linux x86_64 sandbox:
...
- `../../construction/archive/date/20260703/20260703-021412_counsel-and-confirmation-tests.md` -- the earlier Cursor for iOS round that first used this exact pip recipe, against a persistent ai-jail host rather than a disposable cloud VM.
