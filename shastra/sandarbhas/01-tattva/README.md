...
**Style:** Bhakta, Radiant register - **Last updated:** 2026-09-18
**Verified sources:** `elkman-s.-tattva-sandarbha-1986` (Stuart Elkman's academic study and
translation), `tattva_sandarbha` (Hindi translation ed.), `tattva-sandarbha.-acyuta-grantha-mala`
(Sanskrit ed.) -- all three confirmed live in [`../../README.md`](../../README.md)
...
names itself, in its own opening verses, as composed after Vyasa -- who had already written every
other scripture, including the Vedanta-sutra -- remained unsatisfied; its own frame story has the
sage Narada diagnosing that dissatisfaction and prescribing the Bhagavatam as the cure. Its opening
words are read as structurally echoing the Vedanta-sutra's own opening aphorism, which the
tradition takes as a signal that the Bhagavata is Vyasa's own commentary on his own philosophical
summary. And its content is read as satisfying the classical ten characteristics of a complete
Purana (dasa-lakshana) more fully than its rivals.
...
## Why this is the crux, structurally rather than just by Jiva's own placement

Every claim in [`../02-bhagavat/README.md`](../02-bhagavat/README.md) about the nature of the
