...
2. **Run the coupled witness** — `rishi/bin/rishi run tools/gen/chapter/sunn13_root_survey_witness.rish` must go **GREEN** against the new name. A RED here means the debride and its witness fell out of step.
