...
**Status:** Vision -- Self-approved design round (autonomous loop) · **Chapter A** (Hardware & Right-to-Repair) · waymark **HUNK** · journey **Open Image**
...
An **edge-detect** verb (Sobel or Laplacian) is now a single kernel over `convolve` — the natural next agent-doable round, alongside the general-angle hue rotation and the wider Chapter-A journeys.
