...
|---|---|
| **ales** -- Chapter C's Lotus creative suite | **239** |
| equinox | 123 |
| hunk | 86 |
| mycelium | 69 |
| glow | 61 |

Chapter C had built 240 audio modules in `lotus/` and written a witness for each rung as it landed.
...
measures 20m20s to 22m19s and a lap reads it twice, and Chapter C's Lotus rungs are stable while
