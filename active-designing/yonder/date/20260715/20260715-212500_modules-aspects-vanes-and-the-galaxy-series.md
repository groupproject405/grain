...
- The **runtime substrate** and the **enclosure** are the layers *beneath and around* the vanes, named in `../external-research/20260715-165000_glow-non-vane-strata-and-pond.md`: Rye - Kyri - Aurora - Tally (substrate); Pool's host, Caravan's capability table, Pond's customs, Puddle's ephemeral isolation (enclosure).
