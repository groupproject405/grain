...
**Status:** Vision -- Living (design capture, self-approved round) · **Chapter:** double-seat expansion D — Constel test-networks
...
next Lindy-first crux lives in the double-seat expansion, Chapter D, where the loop just seated the
...
This is that harness. It is the **crux** of Chapter D — the decisive, still-tractable move that opens the
...
once and every later Chapter-D rung has a bench. It is also high **Lindy**: a dev-net harness is read and
