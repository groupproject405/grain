# GISM Journey 5 — Real Corpora (Chapter 2, Yield): exploration
...
**Itinerary journey:** Chapter 2 — Yield · **Journey 5 — Real corpora**
**Status:** Mixed -- Self-approved design round — opens Chapter 2 of the 1,024-round itinerary
...
Chapter 1 — The World (TACT) — carried every agent-doable journey to its edge: Ship-Pilot whole (J1), Publishing and Commerce complete to their custody gates (J2, J4), Grainphone waiting on served hardware (J3). The remaining TACT rungs all reach a keeper's-hand gate — a served Pond, a funds rail, a Kumara instance. So the next durable crux on the *whole* 1,024-round road is the first journey of Chapter 2, **Yield**.
