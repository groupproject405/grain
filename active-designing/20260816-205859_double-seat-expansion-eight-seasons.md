...
- **Dimeroll -> Dimeroll** -- a **breach rename EXECUTED `20260817`** (Keaton bought `dimeroll.com`). The entity books (Chapter 2, Journey 8) stand; Dimeroll is the born name they now carry. **Cairn required** (see the breach queue).
