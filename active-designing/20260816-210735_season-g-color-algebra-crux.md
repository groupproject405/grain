# Chapter G — the open colour algebra in Rye (the smallest tractable crux)
...
**Kin:** [`the eight-season double-seat`](20260816-205859_double-seat-expansion-eight-seasons.md) (Chapter G — Open Media Primitives) · [`image/qoi.rye`](../image/qoi.rye) (the sibling open primitive) · [`rye-first crypto parity`](20260815-175524_rye-first-crypto-parity-and-the-decision-wave.md) (the Rye-first spine)
