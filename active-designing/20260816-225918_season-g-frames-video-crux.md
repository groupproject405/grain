# Chapter G -- the intra-frame video container (gfv1), the crux after the glyph atlas

**Stamp:** `20260816.225918` - **Status:** Living (design capture) - **Voice:** Kyri - **Style:** Radiant
**Kin:** [`the eight-season double-seat`](20260816-205859_double-seat-expansion-eight-seasons.md) (Chapter G) - [`image/qoi.rye`](../image/qoi.rye) - [`image/glyph.rye`](../image/glyph.rye) - [`the growing-a-language method`](yonder/20260618-184912_growing-a-language.md)
...
The open-media family has grown color (`image/color.rye`), image (`image/qoi.rye`), and the glyph atlas (`image/glyph.rye`), each GREEN on metal. Chapter G names the next open-media rung plainly: **intra-frame video**, and it names how to begin -- *start smallest*: a self-describing, content-addressed **QOI-per-frame** stream, where landscape / portrait / square are container metadata rather than new math (`20260816-205859_double-seat-expansion-eight-seasons.md`, Chapter G).
