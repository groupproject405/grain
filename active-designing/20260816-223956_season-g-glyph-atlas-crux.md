# Chapter G, the open glyph atlas -- fonts, the second rung after color

**Stamp:** `20260816.223956` -- **Status:** Mixed -- Living (self-approved design round) -- **Voice:** Kyri -- **Style:** Radiant
**Chapter:** G (Open Media Primitives) -- the open-font rung, beside `image/color.rye` (color) and `image/qoi.rye` (image)
**Kin:** [`the eight-season double-seat`](20260816-205859_double-seat-expansion-eight-seasons.md) (Chapter G) -- [`the color crux`](20260816-210735_season-g-color-algebra-crux.md) -- `image/qoi.rye` (the codec whose shape this echoes)
...
Chapter G finishes the open-media family that image (QOI, HUNK) and audio (the wire, ALES) began. The color
