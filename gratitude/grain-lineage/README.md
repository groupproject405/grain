...
- **`silicon_torus_hpc_hardware_proposal_whitepaper.md`** — the solid-silicon-torus hardware proposal. Authors: @kae3g, Glow G2; Grain Research Agent. Source: `codeberg.org/groupproject9/xy-mathematics`, `torus-space-ground/`.
...
- **`topos-aether-agni-geometry.md`** — the topos/sheaf convergence essay (Grothendieck, Schreiber, Frenkel, Vedic Agni/akasha/Vishnu). Written by Kaeden and Reya 2.
