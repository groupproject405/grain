...
*Q3–Q5: version · bounds · CliError. Shared bounds agree via `tools/amphora_bounds_agree.rish` (path C · alias groups). Pour/carry/restore wait their quests. Nested wave lean: **the Crossing Chapter** (seat Keaton's).*
