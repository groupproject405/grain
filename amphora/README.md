...
*Q3–Q5 + e148: version · bounds · CliError · declared `couples:` markers. Shared bounds agree via `tools/amphora_bounds_agree.rish` (path C · alias · couples). Pour/carry/restore wait their quests. Nested wave lean: **the Crossing Chapter** (seat Keaton's).*
