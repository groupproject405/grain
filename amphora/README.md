...
*Q3–Q6: version · bounds · CliError · couples · pour parse (`PourArgs`). Shared bounds agree via `tools/amphora_bounds_agree.rish` (path C · alias · couples). Pour/carry/restore wait their quests. Nested wave lean: **the Crossing Chapter** (seat Keaton's).*
