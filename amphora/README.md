...
*Q3 lands `version`. Q4 names bounds. Shared vessel bounds agree via `tools/amphora_bounds_agree.rish` (path C · no rename). Pour/carry/restore wait their quests. Nested wave lean: **the Crossing Chapter** (seat Keaton's).*
