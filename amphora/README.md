...
**Last updated:** `20260908.083311` (the room's guard count AND its guard list both read off `tools/fixtures/am/amphora_roster_scan.sh` -- `readme_unnamed` holds this page's list at zero, so a guard seated without a name here reds on the lap it arrives)
