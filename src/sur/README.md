...
**Language:** EN  
**Last updated:** 2026-07-28 (Surface p10 — first resident pedestal)  
...
| --- | --- | --- |
| [`shape-surface-count.glow`](shape-surface-count.glow) | One-field `@u32` count · placarded | `tools/gen/chapter/src_first_resident_witness.rish` |
