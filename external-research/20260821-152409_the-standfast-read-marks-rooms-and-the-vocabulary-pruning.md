...
| `tools/gen/chapter/fascia_metric_v0.rish` | **RED** -- fails before it measures |
...
- **The MUR Chapter** announced `u0-u127` and paused at **u91**.
- **The Inner Scope Chapter** announced `i0-i15` and paused at **i6**.
- **The Geode Chapter** announced `d0-d15` and reached **two rooms of twelve**.
...
- **What went wrong:** `tools/gen/chapter/fascia_metric_v0.rish` cannot produce a fascia reading. It fails at line 29 on `assert amphora2.ok`, because `tools/gen/amphora/amphora_lap2.rish` fails its own witness. The health meter has been unable to report for an unknown span, and no living surface noticed.
